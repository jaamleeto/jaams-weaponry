...
public class QuickSwapItemTooltip {
    ...
    private static void addSwapModeIfEnabled(ItemStack stack, List<Component> tooltip) {
        ...
        switch (mode) {
            case INSTANT_ON_RIGHT_CLICK:
                modeKey = "tooltip.jaams_weaponry.properties.quick_swap_mode.instant";
                break;
            case CHARGE_AND_RELEASE:
                modeKey = "tooltip.jaams_weaponry.properties.quick_swap_mode.charge_release";
                break;
            case CHARGE_AND_FINISH_USING:
                modeKey = "tooltip.jaams_weaponry.properties.quick_swap_mode.charge_finishing";
                break;
            case CHARGE_RELEASE_AND_FINISH:
                modeKey = "tooltip.jaams_weaponry.properties.quick_swap_mode.charge_hybrid";
                break;
            default:
                modeKey = "tooltip.jaams_weaponry.properties.quick_swap_mode.instant";
                break;
    ...
    private static void addTargetItemLine(ItemStack stack, List<Component> tooltip) {
        ...
        if (targetItemId != null && !targetItemId.isEmpty()) {
            ...
            if (loc != null) {
                net.minecraft.world.item.Item targetItem = net.minecraftforge.registries.ForgeRegistries.ITEMS
                        .getValue(loc);
    ...
    private static String getTargetItemId(ItemStack stack) {
        ...
        ResourceLocation registryKey = net.minecraftforge.registries.ForgeRegistries.ITEMS.getKey(stack.getItem());
        if (registryKey == null)
            return null;
