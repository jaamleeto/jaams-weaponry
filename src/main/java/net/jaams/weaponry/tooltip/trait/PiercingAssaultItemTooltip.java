...
public class PiercingAssaultItemTooltip {
    ...
    private static void addActivationModeLine(ItemStack stack, List<Component> tooltip) {
        ...
        switch (mode) {
            case SPRINT_CLICK:
                modeKey = "tooltip.jaams_weaponry.properties.piercing_assault.mode.sprint_click";
                break;
            case INSTANT_ON_RIGHT_CLICK:
                modeKey = "tooltip.jaams_weaponry.properties.piercing_assault.mode.instant";
                break;
            case CHARGE_AND_RELEASE:
                modeKey = "tooltip.jaams_weaponry.properties.piercing_assault.mode.charge_release";
                break;
            case CHARGE_AND_FINISH_USING:
                modeKey = "tooltip.jaams_weaponry.properties.piercing_assault.mode.charge_finishing";
                break;
            case CHARGE_RELEASE_AND_FINISH:
                modeKey = "tooltip.jaams_weaponry.properties.piercing_assault.mode.charge_hybrid";
                break;
            default:
                modeKey = "tooltip.jaams_weaponry.properties.piercing_assault.mode.sprint_click";
                break;
