...
public class ThrowableProngedKunaiTooltip {
    ...
    private static boolean isProngedKunai(ItemStack stack) {
        return stack.is(ModTags.PRONGED_KUNAIS)
                || ModUtils.getBooleanNBT(stack, "ForceProngedKunaiThrowable") == Boolean.TRUE;
    }
    ...
    private static boolean isThrowableEnabled(ItemStack stack) {
        ...
        if (!isProngedKunai(stack))
            return false;
        if (!ThrowableConfig.THROWABLE_PRONGED_KUNAI.get())
            return false;
    ...
    private static ModEnums.ThrowMode getThrowMode(ItemStack stack) {
        ...
        return ThrowableConfig.THROWABLE_PRONGED_KUNAI_THROW_MODE.get();
    }
    ...
    private static void addMainTraits(ItemStack stack, List<Component> tooltip) {
        ...
        if (isBackstabShotEnabled(stack)) {
    ...
    private static void addThrowingPropertiesIfEnabled(ItemStack stack, List<Component> tooltip,
        ...
        addBackstabPropertiesIfEnabled(stack, tooltip);
    }
    ...
    private static void addBackstabPropertiesIfEnabled(ItemStack stack, List<Component> tooltip) {
        ...
        double multiplier = ModProjectiles.getBackstabShotDamageMultiplier(stack,
        ...
        ModTooltips.addStat(stack, tooltip, "backstab_shot_multiplier", ModTooltips.roundToTwoDecimals(multiplier));
    }
    ...
    private static void addBaseDamage(ItemStack stack, List<Component> tooltip) {
        ...
        if (nbtDamage != null) {
            ...
            baseDamage += ProjectileCommonConfig.PRONGED_KUNAI_PROJECTILE_BASE_DAMAGE.get();
        }
        baseDamage += 1.0;
    ...
    private static void addBaseKnockback(ItemStack stack, List<Component> tooltip) {
        ...
        if (nbtKb != null) {
            ...
            knockback = ProjectileCommonConfig.PRONGED_KUNAI_PROJECTILE_BASE_KNOCKBACK.get();
        }
    ...
    private static void addChargeTimesIfApplicable(ItemStack stack, List<Component> tooltip, boolean isInstant) {
        ...
        if (minCharge == null || minCharge <= 0) {
            minCharge = ThrowableConfig.THROWABLE_PRONGED_KUNAI_MIN_CHARGE.get();
        }
        Integer maxCharge = ModUtils.getIntNBT(stack, "ThrowableMaxChargeTicks");
        if (maxCharge == null || maxCharge <= 0) {
            maxCharge = ThrowableConfig.THROWABLE_PRONGED_KUNAI_MAX_CHARGE.get();
        }
    ...
    private static void addSpeedStats(ItemStack stack, List<Component> tooltip, boolean isInstant) {
        ...
        double minSpeed = (minSpeedNBT != null && minSpeedNBT > 0) ? minSpeedNBT
                : ThrowableConfig.THROWABLE_PRONGED_KUNAI_MIN_SPEED.get().doubleValue();
        ...
        double maxSpeed = (maxSpeedNBT != null && maxSpeedNBT > 0) ? maxSpeedNBT
                : ThrowableConfig.THROWABLE_PRONGED_KUNAI_MAX_SPEED.get().doubleValue();
        if (isInstant) {
    ...
    private static void addInaccuracy(ItemStack stack, List<Component> tooltip) {
        ...
        double inaccuracy = (inaccuracyNBT != null && inaccuracyNBT > 0) ? inaccuracyNBT
                : ThrowableConfig.THROWABLE_PRONGED_KUNAI_INACCURACY.get().doubleValue();
    ...
    private static void addPiercingLevel(ItemStack stack, List<Component> tooltip) {
        int piercingLevel = ProjectileCommonConfig.PRONGED_KUNAI_PROJECTILE_PIERCING_LEVEL.get();
    ...
    private static void addCooldownIfInstant(ItemStack stack, List<Component> tooltip, boolean isInstant) {
        ...
        int cooldownTicks = (cooldown != null && cooldown >= 0) ? cooldown
                : ThrowableConfig.THROWABLE_PRONGED_KUNAI_COOLDOWN_TICKS_INSTANT.get();
    ...
    private static void addRecoil(ItemStack stack, List<Component> tooltip) {
        ...
        double recoil = (recoilNBT != null && recoilNBT >= 0) ? recoilNBT
                : ThrowableConfig.THROWABLE_PRONGED_KUNAI_RECOIL.get().doubleValue();
    ...
    private static void addWaterInertia(ItemStack stack, List<Component> tooltip) {
        ...
        double waterInertia = (inertiaNBT != null && inertiaNBT > 0) ? inertiaNBT
                : ProjectileCommonConfig.PRONGED_KUNAI_PROJECTILE_WATER_INERTIA.get().doubleValue();
    ...
    private static void addThrowingModeIfEnabled(ItemStack stack, List<Component> tooltip,
        ...
        String modeKey;
        switch (throwMode) {
            case INSTANT_ON_RIGHT_CLICK:
                modeKey = "tooltip.jaams_weaponry.properties.throw_mode.instant";
                break;
            case CHARGE_AND_RELEASE:
                modeKey = "tooltip.jaams_weaponry.properties.throw_mode.charge_release";
                break;
            case CHARGE_AND_FINISH_USING:
                modeKey = "tooltip.jaams_weaponry.properties.throw_mode.charge_finishing";
                break;
            case CHARGE_RELEASE_AND_FINISH:
                modeKey = "tooltip.jaams_weaponry.properties.throw_mode.charge_hybrid";
                break;
            default:
                modeKey = "tooltip.jaams_weaponry.properties.throw_mode.charge_release";
                break;
