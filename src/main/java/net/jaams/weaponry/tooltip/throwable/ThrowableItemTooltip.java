    ...
    private static void addThrowingMode(ItemStack stack, List<Component> tooltip, ModEnums.ThrowMode throwMode) {
        ...
        switch (throwMode) {
            case INSTANT_ON_RIGHT_CLICK:
                key = "tooltip.jaams_weaponry.properties.throw_mode.instant";
                break;
            case CHARGE_AND_RELEASE:
                key = "tooltip.jaams_weaponry.properties.throw_mode.charge_release";
                break;
            case CHARGE_AND_FINISH_USING:
                key = "tooltip.jaams_weaponry.properties.throw_mode.charge_finishing";
                break;
            case CHARGE_RELEASE_AND_FINISH:
                key = "tooltip.jaams_weaponry.properties.throw_mode.charge_hybrid";
                break;
            default:
                key = "tooltip.jaams_weaponry.properties.throw_mode.charge_release";
                break;
