...
public class EffectsConfig {
    ...
    public static ForgeConfigSpec.BooleanValue INCAPABLE;
    public static ForgeConfigSpec.DoubleValue INCAPABLE_ATTACK_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue INCAPABLE_ATTACK_DAMAGE_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.BooleanValue INCAPABLE_RESTRICT_ITEM_USE;
    public static ForgeConfigSpec.BooleanValue INCAPABLE_RESTRICT_BLOCK_INTERACTION;
    
    public static ForgeConfigSpec.BooleanValue DEPLETION;
    public static ForgeConfigSpec.DoubleValue DEPLETION_ATTACK_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue DEPLETION_MOVEMENT_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue DEPLETION_ATTACK_DAMAGE_ATTRIBUTE_MULTIPLIER;
    
    public static ForgeConfigSpec.BooleanValue KNOCKED_OUT;
    public static ForgeConfigSpec.DoubleValue KNOCKED_OUT_ATTACK_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue KNOCKED_OUT_MOVEMENT_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.BooleanValue KNOCKED_OUT_RESTRICT_ITEM_USE;
    public static ForgeConfigSpec.BooleanValue KNOCKED_OUT_RESTRICT_BLOCK_INTERACTION;
    public static ForgeConfigSpec.BooleanValue KNOCKED_OUT_RESTRICT_JUMP;
    public static ForgeConfigSpec.BooleanValue KNOCKED_OUT_RESTRICT_ATTACKING;
    
    public static ForgeConfigSpec.BooleanValue VIGOROUS_RAGE;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_ATTACK_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_KNOCKBACK_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_MOVEMENT_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_BASE_UPGRADE_CHANCE;
    public static ForgeConfigSpec.IntValue VIGOROUS_RAGE_MAX_LEVEL;
    public static ForgeConfigSpec.IntValue VIGOROUS_RAGE_MAX_DURATION_TICKS;
    public static ForgeConfigSpec.IntValue VIGOROUS_RAGE_MIN_EXTRA_TICKS;
    public static ForgeConfigSpec.IntValue VIGOROUS_RAGE_MAX_EXTRA_TICKS;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_UPGRADE_CHANCE_DECAY;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_HEALTH_SCALING_FACTOR;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_MIN_HEALTH_THRESHOLD;
    public static ForgeConfigSpec.DoubleValue VIGOROUS_RAGE_MAX_HEALTH_THRESHOLD;
    
    public static ForgeConfigSpec.BooleanValue WARRIORS_GRACE;
    public static ForgeConfigSpec.DoubleValue WARRIORS_GRACE_CRIT_DAMAGE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue WARRIORS_GRACE_DAMAGE_REDUCTION_PER_LEVEL;
    public static ForgeConfigSpec.DoubleValue WARRIORS_GRACE_ATTACK_DAMAGE_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue WARRIORS_GRACE_KNOCKBACK_RESISTANCE_ATTRIBUTE_MULTIPLIER;
    
    public static ForgeConfigSpec.BooleanValue ARCHERS_GRACE;
    public static ForgeConfigSpec.DoubleValue ARCHERS_GRACE_DAMAGE_MULTIPLIER;
    public static ForgeConfigSpec.IntValue ARCHERS_GRACE_MIN_USE_TICKS;
    public static ForgeConfigSpec.DoubleValue ARCHERS_GRACE_ATTACK_SPEED_ATTRIBUTE_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue ARCHERS_GRACE_KNOCKBACK_ATTRIBUTE_MULTIPLIER;
