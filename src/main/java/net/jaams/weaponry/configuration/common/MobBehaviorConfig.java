...
public class MobBehaviorConfig {
    ...
    public static ModConfigSpec.BooleanValue GUN_MOBS_SHOOT;
    public static ModConfigSpec.BooleanValue GUN_MOBS_NEED_AMMO;
    public static ModConfigSpec.IntValue GUN_MOB_BEHAVIOR_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue GUN_MOB_BEHAVIOR_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.IntValue GUN_MOB_BEHAVIOR_INITIAL_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue GUN_MOB_BEHAVIOR_INITIAL_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.DoubleValue GUN_MOB_BEHAVIOR_COOLDOWN_EASY_MULTIPLIER;
    public static ModConfigSpec.DoubleValue GUN_MOB_BEHAVIOR_COOLDOWN_NORMAL_MULTIPLIER;
    public static ModConfigSpec.DoubleValue GUN_MOB_BEHAVIOR_COOLDOWN_HARD_MULTIPLIER;
    public static ModConfigSpec.DoubleValue GUN_MOB_BEHAVIOR_MIN_SHOOT_DISTANCE;
    public static ModConfigSpec.DoubleValue GUN_MOB_BEHAVIOR_MELEE_DISTANCE;
    public static ModConfigSpec.BooleanValue GUN_MOB_BEHAVIOR_CHECK_CLEAR_SHOT;
    public static ModConfigSpec.BooleanValue GUN_MOB_BEHAVIOR_USE_GUN_BASE_COOLDOWN;
    public static ModConfigSpec.DoubleValue GUN_MOB_BEHAVIOR_GUN_BASE_COOLDOWN_MULTIPLIER;

    public static ModConfigSpec.IntValue THROWABLE_MOB_BEHAVIOR_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue THROWABLE_MOB_BEHAVIOR_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.IntValue THROWABLE_MOB_BEHAVIOR_INITIAL_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue THROWABLE_MOB_BEHAVIOR_INITIAL_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_COOLDOWN_EASY_MULTIPLIER;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_COOLDOWN_NORMAL_MULTIPLIER;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_COOLDOWN_HARD_MULTIPLIER;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_MIN_THROW_DISTANCE;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_MELEE_DISTANCE;
    public static ModConfigSpec.BooleanValue THROWABLE_MOB_BEHAVIOR_CHECK_CLEAR_SHOT;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_CRITICAL_CHANCE;
    public static ModConfigSpec.DoubleValue THROWABLE_MOB_BEHAVIOR_INACCURACY_MULTIPLIER;
    public static ModConfigSpec.BooleanValue THROWABLE_MOBS_THROW;



    public static ModConfigSpec.BooleanValue QUICK_SWAP_MOBS_ENABLED;
    public static ModConfigSpec.IntValue QUICK_SWAP_MOB_BEHAVIOR_INITIAL_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue QUICK_SWAP_MOB_BEHAVIOR_INITIAL_COOLDOWN_MAX_TICKS;



    public static ModConfigSpec.BooleanValue SMOKE_BOMB_MOBS_USE;
    public static ModConfigSpec.IntValue SMOKE_BOMB_MOB_BEHAVIOR_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue SMOKE_BOMB_MOB_BEHAVIOR_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.IntValue SMOKE_BOMB_MOB_BEHAVIOR_INITIAL_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue SMOKE_BOMB_MOB_BEHAVIOR_INITIAL_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.DoubleValue SMOKE_BOMB_MOB_BEHAVIOR_COOLDOWN_EASY_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SMOKE_BOMB_MOB_BEHAVIOR_COOLDOWN_NORMAL_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SMOKE_BOMB_MOB_BEHAVIOR_COOLDOWN_HARD_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SMOKE_BOMB_MOB_BEHAVIOR_EFFECT_RADIUS;
    public static ModConfigSpec.DoubleValue SMOKE_BOMB_MOB_BEHAVIOR_USE_PROBABILITY;

    public static ModConfigSpec.BooleanValue SLINGSHOT_MOBS_SHOOT;
    public static ModConfigSpec.BooleanValue SLINGSHOT_MOBS_NEED_AMMO;
    public static ModConfigSpec.IntValue SLINGSHOT_MOB_BEHAVIOR_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue SLINGSHOT_MOB_BEHAVIOR_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.IntValue SLINGSHOT_MOB_BEHAVIOR_INITIAL_COOLDOWN_MIN_TICKS;
    public static ModConfigSpec.IntValue SLINGSHOT_MOB_BEHAVIOR_INITIAL_COOLDOWN_MAX_TICKS;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_COOLDOWN_EASY_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_COOLDOWN_NORMAL_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_COOLDOWN_HARD_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_MIN_SHOOT_DISTANCE;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_MELEE_DISTANCE;
    public static ModConfigSpec.BooleanValue SLINGSHOT_MOB_BEHAVIOR_CHECK_CLEAR_SHOT;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_INACCURACY_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SLINGSHOT_MOB_BEHAVIOR_THROW_PROBABILITY;
    public static ModConfigSpec.ConfigValue<String> SLINGSHOT_DEFAULT_AMMO;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SLINGSHOT_MOB_AMMO_OVERRIDES;
