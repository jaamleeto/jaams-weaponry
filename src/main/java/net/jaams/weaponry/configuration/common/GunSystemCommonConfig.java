...
public class GunSystemCommonConfig {
    ...
    public static ForgeConfigSpec.IntValue GUN_REVOLVER_MAX_AMMO;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_MAX_AMMO;
    ...
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_PROJECTILE_DAMAGE_MODIFIER;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_PROJECTILE_KNOCKBACK_MODIFIER;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_PROJECTILE_PIERCING_MODIFIER;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_PROJECTILE_COUNT;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_INACCURACY;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_COOLDOWN;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_OFFHAND_COOLDOWN;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_DEFAULT_MODIFIER;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_SPREAD_ANGLE;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_GUN_SHOT_SIZE;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_GUN_SHOT_DISTANCE;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_SHAKE_INTENSITY;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_SHAKE_RESET_DELAY;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_RECOIL_DISTANCE;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_CROUCH_RECOIL_REDUCTION;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_VERTICAL_RECOIL_MULTIPLIER;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_XROT_RECOIL_INTENSITY;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_PROJECTILE_SPEED;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_MUZZLE_MODIFIER;
    public static ForgeConfigSpec.DoubleValue GUN_PEPPERBOX_SHOOT_MAGAZINE_MODIFIER;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_ATTACHMENT_CONSUMPTION;
    public static ForgeConfigSpec.IntValue GUN_PEPPERBOX_SHOOT_AMMO_CONSUMPTION;
    public static ForgeConfigSpec.EnumValue<ModEnums.GunFirePattern> GUN_PEPPERBOX_SHOOT_FIRE_PATTERN;
    public static void register(ForgeConfigSpec.Builder builder) {
        ...
        GUN_AMMO_FROM_GUN = builder.comment("Take ammo from the gun's inventory").define("Ammo From Gun Inventory",
                true);
        ...
        GUN_REVOLVER_MAX_AMMO = builder.comment("Default maximum ammo per slot for revolvers (each chamber, max 64)")
                .defineInRange("Revolver Max Ammo Capacity", 1, 1, 64);
        GUN_PEPPERBOX_MAX_AMMO = builder.comment("Default maximum ammo per slot for pepperboxes (each barrel, max 64)")
        ...
        GUN_PEPPERBOX_SHOOT_PROJECTILE_PIERCING_MODIFIER = builder.comment("Projectile piercing modifier for pepperbox")
                .defineInRange("Projectile Piercing Modifier", 0, 0, 10);
        GUN_PEPPERBOX_SHOOT_PROJECTILE_COUNT = builder
                .comment("Number of projectiles fired per loaded barrel per pepperbox shot")
                .defineInRange("Projectile Count", 1, 1, 100);
