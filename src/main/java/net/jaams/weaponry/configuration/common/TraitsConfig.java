...
public class TraitsConfig {
    ...
    public static ModConfigSpec.BooleanValue THROWABLE;
    public static ModConfigSpec.BooleanValue THROWBACK;
    public static ModConfigSpec.BooleanValue COLLECTOR;
    public static ModConfigSpec.BooleanValue DISARMING_SHOT;
    public static ModConfigSpec.BooleanValue DISABLING_SHOT;
    public static ModConfigSpec.BooleanValue SWEEPING_SHOT;
    public static ModConfigSpec.BooleanValue BACKSTAB_SHOT;
    public static ModConfigSpec.BooleanValue PIERCING_SHOT;
    public static ModConfigSpec.BooleanValue GUARD_STANCE;
    public static ModConfigSpec.BooleanValue GUARD_STANCE_COOLDOWN;
    public static ModConfigSpec.BooleanValue GUARD_STANCE_AREA_DAMAGE;
    public static ModConfigSpec.BooleanValue GUARD_STANCE_APPLY_FIRST_PERSON_TRANSFORM;
    public static ModConfigSpec.IntValue GUARD_STANCE_COOLDOWN_TICKS;
    public static ModConfigSpec.BooleanValue GUARD_STANCE_GLOBAL_COOLDOWN;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_AREA_DAMAGE_MULTIPLIER;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_KNOCKBACK_FORCE;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_AREA_RANGE;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_BLOCK_DAMAGE_REDUCTION;
    public static ModConfigSpec.IntValue GUARD_STANCE_DAMAGE_PER_BLOCK;
    public static ModConfigSpec.IntValue GUARD_STANCE_DAMAGE_ON_STOP;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_PARTICLE_SIZE;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_PARTICLE_DISTANCE;
    public static ModConfigSpec.DoubleValue GUARD_STANCE_NO_DURABILITY_BREAK_CHANCE;
    public static ModConfigSpec.BooleanValue PARRY_GUARD;
    public static ModConfigSpec.IntValue PARRY_GUARD_COOLDOWN_TICKS;
    public static ModConfigSpec.BooleanValue PARRY_GUARD_GLOBAL_COOLDOWN;
    public static ModConfigSpec.DoubleValue PARRY_GUARD_BLOCK_DAMAGE_REDUCTION;
    public static ModConfigSpec.IntValue PARRY_GUARD_DAMAGE_PER_BLOCK;
    public static ModConfigSpec.IntValue PARRY_GUARD_DAMAGE_ON_STOP;

    public static ModConfigSpec.DoubleValue PARRY_GUARD_NO_DURABILITY_BREAK_CHANCE;
    public static ModConfigSpec.BooleanValue PIERCER_STRIKE;
    public static ModConfigSpec.BooleanValue DUELIST;
    public static ModConfigSpec.BooleanValue THREAT_RESPONSE;
    public static ModConfigSpec.BooleanValue REACH_ADVANTAGE;
    public static ModConfigSpec.BooleanValue AFTER_STRIKE;
    public static ModConfigSpec.BooleanValue RAPID_BOOST;
    public static ModConfigSpec.BooleanValue POWER_BOOST;
    public static ModConfigSpec.BooleanValue BUSTER_STRIKE;
    public static ModConfigSpec.BooleanValue QUICK_CRAFTING;
    public static ModConfigSpec.BooleanValue AQUATIC_GRUDGE;
    public static ModConfigSpec.BooleanValue ARTHROPOD_GRUDGE;
    public static ModConfigSpec.BooleanValue UNDEAD_GRUDGE;
    public static ModConfigSpec.BooleanValue TRAITOR_GRUDGE;
    public static ModConfigSpec.BooleanValue SNOUT_GRUDGE;
    public static ModConfigSpec.BooleanValue BONE_GRUDGE;
    public static ModConfigSpec.BooleanValue ANTI_AERIAL;

    public static ModConfigSpec.BooleanValue ROTTEN_GRUDGE;
    public static ModConfigSpec.BooleanValue ARMOR_BREAKER;
    public static ModConfigSpec.BooleanValue BLADE_BREAKER;
    public static ModConfigSpec.BooleanValue ACROBATIC_LUNGE;
    public static ModConfigSpec.BooleanValue DEXTEROUS_LUNGE;
    public static ModConfigSpec.BooleanValue PULL_LUNGE;
    public static ModConfigSpec.BooleanValue DISENGAGE;
    public static ModConfigSpec.BooleanValue DISARM;
    public static ModConfigSpec.BooleanValue DISMOUNT;
    public static ModConfigSpec.BooleanValue DISABLING_STRIKE;
    public static ModConfigSpec.BooleanValue THROUGH_STRIKE;
    public static ModConfigSpec.BooleanValue CLEANSING_STRIKE;
    public static ModConfigSpec.BooleanValue OVERWHELMING_STRIKE;
    public static ModConfigSpec.BooleanValue SMASH_STRIKE;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_DAMAGE_PER_BLOCK;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_MAX_BONUS_DAMAGE;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_RESIDUAL_DAMAGE_BASE;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_RESIDUAL_DAMAGE_PER_BLOCK;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_MAX_RESIDUAL_DAMAGE;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_SMASH_RADIUS;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_SHAKE_INTENSITY;
    public static ModConfigSpec.IntValue SMASH_STRIKE_SHAKE_RESET_DELAY;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_ALLY_DAMAGE_MULTIPLIER;
    public static ModConfigSpec.IntValue SMASH_STRIKE_DURABILITY_DAMAGE_BASE;
    public static ModConfigSpec.DoubleValue SMASH_STRIKE_DURABILITY_DAMAGE_PER_BLOCK;
    public static ModConfigSpec.IntValue SMASH_STRIKE_MAX_DURABILITY_DAMAGE;

    public static ModConfigSpec.BooleanValue SHOCK_IMPACT;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_MAX_BONUS_DAMAGE;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_MAX_RESIDUAL_DAMAGE;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_SMASH_RADIUS;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_MIN_KNOCKBACK_STRENGTH;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_MAX_KNOCKBACK_STRENGTH;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_KNOCKBACK_SCALING_FACTOR;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_SHAKE_INTENSITY;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_SHAKE_RESET_DELAY;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_DURABILITY_DAMAGE_BASE;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_MAX_DURABILITY_DAMAGE;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_EXHAUSTION;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_DEPLETION_CHANCE;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_DEPLETION_DURATION;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_DEPLETION_LEVEL;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_DEPLETION_MAX_LEVEL;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_DEPLETION_MAX_DURATION;
    public static ModConfigSpec.BooleanValue SHOCK_IMPACT_ENABLE_DEPLETION;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_PLAYER_VERTICAL_IMPULSE;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_ENTITY_VERTICAL_IMPULSE;
    public static ModConfigSpec.BooleanValue SHOCK_IMPACT_GLOBAL_COOLDOWN;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_COOLDOWN_TICKS;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_BASE_DAMAGE_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_OFFHAND_COOLDOWN_MULTIPLIER;
    public static ModConfigSpec.DoubleValue SHOCK_IMPACT_OFFHAND_POWER_MULTIPLIER;
    public static ModConfigSpec.EnumValue<ModEnums.ShockImpactMode> SHOCK_IMPACT_ACTIVATION_MODE;
    public static ModConfigSpec.BooleanValue SHOCK_IMPACT_REQUIRE_CROUCHING;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_CHARGE_DURATION_TICKS;
    public static ModConfigSpec.EnumValue<UseAnim> SHOCK_IMPACT_CHARGE_ANIMATION;
    public static ModConfigSpec.IntValue SHOCK_IMPACT_MIN_CHARGE_TICKS;

    public static ModConfigSpec.BooleanValue BACKSTAB;
    public static ModConfigSpec.DoubleValue BACKSTAB_MULTIPLIER_NORMAL;
    public static ModConfigSpec.DoubleValue BACKSTAB_MULTIPLIER_SNEAKING;
    public static ModConfigSpec.DoubleValue BACKSTAB_MULTIPLIER_INVISIBLE;
    public static ModConfigSpec.DoubleValue BACKSTAB_MULTIPLIER_SNEAKING_INVISIBLE;
    public static ModConfigSpec.IntValue BACKSTAB_DURABILITY_PENALTY;
    public static ModConfigSpec.DoubleValue BACKSTAB_RIGHT_CLICK_DURABILITY_MULTIPLIER;
    public static ModConfigSpec.DoubleValue BACKSTAB_RIGHT_CLICK_FORWARD_IMPULSE;
    public static ModConfigSpec.DoubleValue BACKSTAB_MAX_DISTANCE;
    public static ModConfigSpec.DoubleValue BACKSTAB_MAX_ANGLE;
    public static ModConfigSpec.DoubleValue BACKSTAB_WEAKNESS_CHANCE;
    public static ModConfigSpec.IntValue BACKSTAB_WEAKNESS_DURATION;
    public static ModConfigSpec.IntValue BACKSTAB_WEAKNESS_LEVEL;
    public static ModConfigSpec.IntValue BACKSTAB_RIGHT_CLICK_COOLDOWN;
    public static ModConfigSpec.BooleanValue BACKSTAB_GLOBAL_COOLDOWN;
    public static ModConfigSpec.DoubleValue BACKSTAB_DARKNESS_BONUS;
    public static ModConfigSpec.DoubleValue BACKSTAB_MOVING_TARGET_PENALTY;
    public static ModConfigSpec.DoubleValue BACKSTAB_GRACE_PERIOD_SECONDS;
    public static ModConfigSpec.DoubleValue BACKSTAB_RIGHT_CLICK_DAMAGE_BONUS;

    public static ModConfigSpec.BooleanValue HEAVY_HANDED;
    public static ModConfigSpec.DoubleValue HEAVY_HANDED_MOVEMENT_SPEED_REDUCTION;
    public static ModConfigSpec.DoubleValue HEAVY_HANDED_ATTACK_SPEED_REDUCTION;
    public static ModConfigSpec.DoubleValue HEAVY_HANDED_ATTACK_DAMAGE_REDUCTION;
    public static ModConfigSpec.DoubleValue HEAVY_HANDED_DURABILITY_FACTOR;
    public static ModConfigSpec.DoubleValue HEAVY_HANDED_DAMAGE_FACTOR;
    public static ModConfigSpec.DoubleValue HEAVY_HANDED_MAX_REDUCTION;

    public static ModConfigSpec.BooleanValue SPARRING_STRIKE;
    public static ModConfigSpec.BooleanValue SLASH_ASSAULT;

    public static ModConfigSpec.BooleanValue PIERCING_ASSAULT;
    public static ModConfigSpec.DoubleValue PIERCING_ASSAULT_DASH_DISTANCE;
    public static ModConfigSpec.DoubleValue PIERCING_ASSAULT_RANGE;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_PIERCE_COOLDOWN;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_NO_TARGET_COOLDOWN;

    public static ModConfigSpec.EnumValue<ModEnums.PiercingAssaultMode> PIERCING_ASSAULT_ACTIVATION_MODE;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_CHARGE_DURATION_TICKS;
    public static ModConfigSpec.EnumValue<UseAnim> PIERCING_ASSAULT_CHARGE_ANIMATION;
    public static ModConfigSpec.DoubleValue PIERCING_ASSAULT_MIN_DAMAGE;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_MIN_CHARGE_TICKS;
    public static ModConfigSpec.BooleanValue PIERCING_ASSAULT_DASH_SWING;
    public static ModConfigSpec.BooleanValue PIERCING_ASSAULT_ATTACK_SWING;
    public static ModConfigSpec.BooleanValue PIERCING_ASSAULT_GLOBAL_COOLDOWN;
    public static ModConfigSpec.DoubleValue PIERCING_ASSAULT_DEPLETION_CHANCE;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_DEPLETION_DURATION;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_DEPLETION_LEVEL;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_DEPLETION_MAX_LEVEL;
    public static ModConfigSpec.IntValue PIERCING_ASSAULT_DEPLETION_MAX_DURATION;
    public static ModConfigSpec.BooleanValue PIERCING_ASSAULT_ENABLE_DEPLETION;
    public static ModConfigSpec.DoubleValue SLASH_ASSAULT_DASH_DISTANCE;
    public static ModConfigSpec.DoubleValue SLASH_ASSAULT_RANGE;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_SLASH_COOLDOWN;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_NO_TARGET_COOLDOWN;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_DURABILITY_COST;
    public static ModConfigSpec.EnumValue<ModEnums.SlashAssaultMode> SLASH_ASSAULT_ACTIVATION_MODE;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_CHARGE_DURATION_TICKS;
    public static ModConfigSpec.EnumValue<UseAnim> SLASH_ASSAULT_CHARGE_ANIMATION;
    public static ModConfigSpec.DoubleValue SLASH_ASSAULT_MIN_DAMAGE;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_MIN_CHARGE_TICKS;
    public static ModConfigSpec.BooleanValue SLASH_ASSAULT_DASH_SWING;
    public static ModConfigSpec.BooleanValue SLASH_ASSAULT_ATTACK_SWING;
    public static ModConfigSpec.BooleanValue SLASH_ASSAULT_GLOBAL_COOLDOWN;
    public static ModConfigSpec.DoubleValue SLASH_ASSAULT_DEPLETION_CHANCE;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_DEPLETION_DURATION;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_DEPLETION_LEVEL;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_DEPLETION_MAX_LEVEL;
    public static ModConfigSpec.IntValue SLASH_ASSAULT_DEPLETION_MAX_DURATION;
    public static ModConfigSpec.BooleanValue SLASH_ASSAULT_ENABLE_DEPLETION;

    public static ModConfigSpec.BooleanValue HARVEST_SWEEP;
    public static ModConfigSpec.IntValue HARVEST_SWEEP_RANGE;
    public static ModConfigSpec.IntValue HARVEST_SWEEP_TILL_RANGE;
    public static ModConfigSpec.IntValue HARVEST_SWEEP_MAX_BLOCKS;
    public static ModConfigSpec.BooleanValue HARVEST_SWEEP_CAN_HARVEST;
    public static ModConfigSpec.IntValue HARVEST_SWEEP_DURABILITY_COST_PER_BLOCK;
    public static ModConfigSpec.BooleanValue HARVEST_SWEEP_DURABILITY_PER_BLOCK;
    public static ModConfigSpec.IntValue HARVEST_SWEEP_TILL_DURABILITY_COST;
    public static ModConfigSpec.IntValue HARVEST_SWEEP_HARVEST_DURABILITY_COST;

    public static ModConfigSpec.BooleanValue WILD_SWEEP;
    public static ModConfigSpec.IntValue WILD_SWEEP_RADIUS;

    public static ModConfigSpec.BooleanValue WHIRLING_STRIKE;
    public static ModConfigSpec.DoubleValue WHIRLING_STRIKE_BASE_DAMAGE;
    public static ModConfigSpec.DoubleValue WHIRLING_STRIKE_BASE_ATTACK_RANGE;
    public static ModConfigSpec.DoubleValue WHIRLING_STRIKE_DUAL_WIELD_RANGE_MULTIPLIER;
    public static ModConfigSpec.DoubleValue WHIRLING_STRIKE_DUAL_WIELD_DAMAGE_MULTIPLIER;
    public static ModConfigSpec.DoubleValue WHIRLING_STRIKE_MAX_DAMAGE_CAP;
    public static ModConfigSpec.IntValue WHIRLING_STRIKE_ITEM_DAMAGE_INTERVAL;
    public static ModConfigSpec.IntValue WHIRLING_STRIKE_ATTACK_INTERVAL;
    public static ModConfigSpec.IntValue WHIRLING_STRIKE_ITEM_DAMAGE_AMOUNT;
    public static ModConfigSpec.IntValue WHIRLING_STRIKE_SINGLE_WIELD_BLOCK_DAMAGE;
    public static ModConfigSpec.IntValue WHIRLING_STRIKE_DUAL_WIELD_BLOCK_DAMAGE;
    public static ModConfigSpec.DoubleValue WHIRLING_STRIKE_USE_DISTANCE;
    public static ModConfigSpec.IntValue WHIRLING_STRIKE_PARTICLE_TICK_INTERVAL;
    public static ModConfigSpec.IntValue WILD_SWEEP_DURABILITY_COST;
    public static ModConfigSpec.IntValue WILD_SWEEP_COOLDOWN;
    public static ModConfigSpec.BooleanValue WILD_SWEEP_GLOBAL_COOLDOWN;
    public static ModConfigSpec.ConfigValue<List<? extends String>> WILD_SWEEP_BREAKABLE_BLOCKS;

    public static ModConfigSpec.IntValue THROWBACK_HUNTERS_BOOMERANG_PROJECTILE_MIN_RANGE;
    public static ModConfigSpec.IntValue THROWBACK_HUNTERS_BOOMERANG_PROJECTILE_MAX_RANGE;
    public static ModConfigSpec.BooleanValue THROWBACK_HUNTERS_BOOMERANG_PROJECTILE_RETURN_ON_MAX_RANGE;
    public static ModConfigSpec.BooleanValue THROWBACK_HUNTERS_BOOMERANG_PROJECTILE_RETURN_ON_ENTITY_HIT;
    public static ModConfigSpec.BooleanValue THROWBACK_HUNTERS_BOOMERANG_PROJECTILE_RETURN_ON_BLOCK_HIT;
    public static ModConfigSpec.DoubleValue THROWBACK_HUNTERS_BOOMERANG_PROJECTILE_RETURN_SPEED;

    public static ModConfigSpec.IntValue THROWBACK_RING_PROJECTILE_MIN_RANGE;
    public static ModConfigSpec.IntValue THROWBACK_RING_PROJECTILE_MAX_RANGE;
    public static ModConfigSpec.BooleanValue THROWBACK_RING_PROJECTILE_RETURN_ON_MAX_RANGE;
    public static ModConfigSpec.BooleanValue THROWBACK_RING_PROJECTILE_RETURN_ON_ENTITY_HIT;
    public static ModConfigSpec.BooleanValue THROWBACK_RING_PROJECTILE_RETURN_ON_BLOCK_HIT;
    public static ModConfigSpec.DoubleValue THROWBACK_RING_PROJECTILE_RETURN_SPEED;

    public static ModConfigSpec.IntValue COLLECTOR_HUNTERS_BOOMERANG_PROJECTILE_MAX_ITEMS;

    public static ModConfigSpec.DoubleValue DISARMING_SHOT_HUNTERS_BOOMERANG_PROJECTILE_CHANCE;
    public static ModConfigSpec.BooleanValue DISARMING_SHOT_HUNTERS_BOOMERANG_PROJECTILE_REQUIRE_CRITICAL;

    public static ModConfigSpec.BooleanValue DISARMING_SHOT_HUNTERS_BOOMERANG_PROJECTILE_MOUNT_ITEM;

    public static ModConfigSpec.DoubleValue DISABLING_SHOT_SHURIKEN_PROJECTILE_CHANCE;
    public static ModConfigSpec.IntValue DISABLING_SHOT_SHURIKEN_PROJECTILE_COOLDOWN;

    public static ModConfigSpec.DoubleValue SWEEPING_SHOT_GIANT_SHURIKEN_PROJECTILE_RADIUS;
    public static ModConfigSpec.DoubleValue SWEEPING_SHOT_GIANT_SHURIKEN_PROJECTILE_DAMAGE_FACTOR;

    public static ModConfigSpec.DoubleValue BACKSTAB_SHOT_PRONGED_KUNAI_PROJECTILE_MULTIPLIER;

    public static ModConfigSpec.DoubleValue PIERCING_SHOT_KUNAI_PROJECTILE_CHANCE;
    public static ModConfigSpec.DoubleValue PIERCING_SHOT_KUNAI_PROJECTILE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue PIERCER_STRIKE_BONUS_DAMAGE;
    public static ModConfigSpec.IntValue PIERCER_STRIKE_MIN_ARMOR;
    public static ModConfigSpec.BooleanValue PIERCER_STRIKE_REQUIRE_FULLY_CHARGED;


    public static ModConfigSpec.DoubleValue DUELIST_BONUS_DAMAGE;
    public static ModConfigSpec.BooleanValue DUELIST_REQUIRE_FULLY_CHARGED;


    public static ModConfigSpec.DoubleValue THREAT_RESPONSE_BONUS_DAMAGE;
    public static ModConfigSpec.BooleanValue THREAT_RESPONSE_REQUIRE_FULLY_CHARGED;


    public static ModConfigSpec.DoubleValue REACH_ADVANTAGE_BONUS_DAMAGE;
    public static ModConfigSpec.DoubleValue REACH_ADVANTAGE_MIN_DISTANCE;
    public static ModConfigSpec.DoubleValue REACH_ADVANTAGE_MAX_DISTANCE;
    public static ModConfigSpec.BooleanValue REACH_ADVANTAGE_REQUIRE_FULLY_CHARGED;


    public static ModConfigSpec.IntValue AFTER_STRIKE_REQUIRED_HITS;
    public static ModConfigSpec.IntValue AFTER_STRIKE_STRIKES_COUNT;
    public static ModConfigSpec.IntValue AFTER_STRIKE_STRIKES_INTERVAL;
    public static ModConfigSpec.DoubleValue AFTER_STRIKE_INITIAL_MODIFIER;
    public static ModConfigSpec.DoubleValue AFTER_STRIKE_DECAY_FACTOR;
    public static ModConfigSpec.BooleanValue AFTER_STRIKE_REQUIRES_CHARGED;
    public static ModConfigSpec.BooleanValue AFTER_STRIKE_CRITICAL_TRIGGERS;


    public static ModConfigSpec.IntValue BUSTER_STRIKE_REQUIRED_HITS;
    public static ModConfigSpec.DoubleValue BUSTER_STRIKE_BONUS_MULTIPLIER;

    public static ModConfigSpec.DoubleValue BUSTER_STRIKE_REMOVE_CHANCE;
    public static ModConfigSpec.BooleanValue BUSTER_STRIKE_REQUIRES_CHARGED;

    public static ModConfigSpec.ConfigValue<String> QUICK_CRAFTING_INGREDIENT;
    public static ModConfigSpec.IntValue QUICK_CRAFTING_INGREDIENT_COUNT;
    public static ModConfigSpec.ConfigValue<String> QUICK_CRAFTING_RESULT;
    public static ModConfigSpec.IntValue QUICK_CRAFTING_RESULT_COUNT;
    public static ModConfigSpec.IntValue QUICK_CRAFTING_USE_DURATION;
    public static ModConfigSpec.IntValue QUICK_CRAFTING_DURABILITY_COST;
    public static ModConfigSpec.IntValue QUICK_CRAFTING_COOLDOWN;
    public static ModConfigSpec.BooleanValue QUICK_CRAFTING_GLOBAL_COOLDOWN;

    public static ModConfigSpec.DoubleValue AQUATIC_GRUDGE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue ARTHROPOD_GRUDGE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue UNDEAD_GRUDGE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue TRAITOR_GRUDGE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue SNOUT_GRUDGE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue BONE_GRUDGE_BONUS_DAMAGE;

    public static ModConfigSpec.DoubleValue ANTI_AERIAL_BONUS_DAMAGE;


    public static ModConfigSpec.DoubleValue ROTTEN_GRUDGE_BONUS_DAMAGE;
    public static ModConfigSpec.DoubleValue ARMOR_BREAKER_CHANCE;
    public static ModConfigSpec.IntValue ARMOR_BREAKER_DURABILITY_DAMAGE;
    public static ModConfigSpec.ConfigValue<List<? extends String>> ARMOR_BREAKER_SLOTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> ARMOR_BREAKER_IMMUNE_ITEMS;
    public static ModConfigSpec.DoubleValue BLADE_BREAKER_CHANCE;
    public static ModConfigSpec.IntValue BLADE_BREAKER_DURABILITY_DAMAGE;
    public static ModConfigSpec.ConfigValue<List<? extends String>> BLADE_BREAKER_IMMUNE_ITEMS;
    public static ModConfigSpec.DoubleValue ACROBATIC_LUNGE_STRENGTH;
    public static ModConfigSpec.DoubleValue ACROBATIC_LUNGE_MAX_DISTANCE;
    public static ModConfigSpec.DoubleValue ACROBATIC_LUNGE_MAX_VERTICAL_PULL;
    public static ModConfigSpec.DoubleValue ACROBATIC_LUNGE_DISTANCE_SCALING;

    public static ModConfigSpec.DoubleValue DEXTEROUS_LUNGE_PULL_STRENGTH;
    public static ModConfigSpec.DoubleValue DEXTEROUS_LUNGE_ATTRACT_STRENGTH;
    public static ModConfigSpec.DoubleValue DEXTEROUS_LUNGE_MAX_DISTANCE;
    public static ModConfigSpec.DoubleValue DEXTEROUS_LUNGE_MAX_VERTICAL_PULL;
    public static ModConfigSpec.DoubleValue DEXTEROUS_LUNGE_DISTANCE_SCALING;

    public static ModConfigSpec.DoubleValue PULL_LUNGE_STRENGTH;
    public static ModConfigSpec.DoubleValue PULL_LUNGE_MAX_DISTANCE;
    public static ModConfigSpec.DoubleValue PULL_LUNGE_MAX_VERTICAL_PULL;
    public static ModConfigSpec.DoubleValue PULL_LUNGE_DISTANCE_SCALING;

    public static ModConfigSpec.DoubleValue DISENGAGE_STRENGTH;
    public static ModConfigSpec.DoubleValue DISENGAGE_MAX_DISTANCE;
    public static ModConfigSpec.DoubleValue DISENGAGE_MAX_VERTICAL_PUSH;
    public static ModConfigSpec.DoubleValue DISENGAGE_DISTANCE_SCALING;

    public static ModConfigSpec.DoubleValue DISARM_CHANCE;
    public static ModConfigSpec.ConfigValue<List<? extends String>> DISARM_NON_DISARMABLE_ITEMS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> DISARM_NON_DISARMABLE_ENTITIES;
    public static ModConfigSpec.DoubleValue DISMOUNT_CHANCE;
    public static ModConfigSpec.ConfigValue<List<? extends String>> DISMOUNT_NON_DISMOUNTABLE_ENTITIES;
    public static ModConfigSpec.DoubleValue DISABLING_STRIKE_CHANCE;
    public static ModConfigSpec.IntValue DISABLING_STRIKE_COOLDOWN;
    public static ModConfigSpec.DoubleValue THROUGH_STRIKE_CHANCE;
    public static ModConfigSpec.DoubleValue CLEANSING_STRIKE_CHANCE;
    public static ModConfigSpec.ConfigValue<List<? extends String>> CLEANSING_STRIKE_BLACKLISTED_EFFECTS;
    public static ModConfigSpec.DoubleValue OVERWHELMING_STRIKE_CHANCE;
    public static ModConfigSpec.IntValue OVERWHELMING_STRIKE_DURATION;
    public static ModConfigSpec.BooleanValue SUPPRESSING_STRIKE;
    public static ModConfigSpec.DoubleValue SUPPRESSING_STRIKE_CHANCE;
    public static ModConfigSpec.IntValue SUPPRESSING_STRIKE_DURATION;


    public static ModConfigSpec.BooleanValue FRAGILITY;
    public static ModConfigSpec.BooleanValue SLIPPERY;
    public static ModConfigSpec.BooleanValue EXHAUSTING;
    public static ModConfigSpec.BooleanValue BRITTLE_HANDLE;
    public static ModConfigSpec.BooleanValue BARBED_HANDLE;
    public static ModConfigSpec.BooleanValue OVERSTRAIN;
    public static ModConfigSpec.BooleanValue UNSTABLE_EDGE;
    public static ModConfigSpec.BooleanValue DETONATING;
    public static ModConfigSpec.BooleanValue DECAPITATION;
    public static ModConfigSpec.DoubleValue DECAPITATION_CHANCE;
    public static ModConfigSpec.DoubleValue DECAPITATION_CRITICAL_MULTIPLIER;

    public static ModConfigSpec.BooleanValue QUICK_SWAP;
    public static ModConfigSpec.BooleanValue QUICK_SWAP_REQUIRE_CROUCH;
    public static ModConfigSpec.IntValue QUICK_SWAP_MAIN_HAND_COOLDOWN;
    public static ModConfigSpec.IntValue QUICK_SWAP_OFF_HAND_COOLDOWN;
    public static ModConfigSpec.BooleanValue QUICK_SWAP_GLOBAL_COOLDOWN;
    public static ModConfigSpec.EnumValue<ModEnums.QuickSwapMode> QUICK_SWAP_ACTIVATION_MODE;
    public static ModConfigSpec.IntValue QUICK_SWAP_CHARGE_DURATION_TICKS;
    public static ModConfigSpec.EnumValue<UseAnim> QUICK_SWAP_CHARGE_ANIMATION;

    public static ModConfigSpec.IntValue RAPID_BOOST_MAX_HITS;
    public static ModConfigSpec.DoubleValue RAPID_BOOST_INCREMENT;

    public static ModConfigSpec.IntValue POWER_BOOST_MAX_HITS;
    public static ModConfigSpec.DoubleValue POWER_BOOST_INCREMENT;
    public static ModConfigSpec.DoubleValue FRAGILITY_BREAK_CHANCE;
    public static ModConfigSpec.DoubleValue FRAGILITY_MIN_DURABILITY_THRESHOLD;
    ...
    public static ModConfigSpec.DoubleValue OVERSTRAIN_CHANCE;
    public static ModConfigSpec.IntValue OVERSTRAIN_EFFECT_DURATION;
    public static ModConfigSpec.IntValue OVERSTRAIN_EFFECT_AMPLIFIER;
    public static ModConfigSpec.DoubleValue UNSTABLE_EDGE_MIN_MULTIPLIER;
    public static ModConfigSpec.DoubleValue UNSTABLE_EDGE_MAX_MULTIPLIER;
    public static ModConfigSpec.DoubleValue DETONATING_EXPLODE_CHANCE;
    public static ModConfigSpec.DoubleValue DETONATING_EXPLOSION_POWER;
    public static ModConfigSpec.BooleanValue DETONATING_BREAK_BLOCKS;
    public static ModConfigSpec.BooleanValue DETONATING_DAMAGE_OWNER;
