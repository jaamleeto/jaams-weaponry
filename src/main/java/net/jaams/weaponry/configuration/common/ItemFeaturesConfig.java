...
public class ItemFeaturesConfig {
    ...
    public static ForgeConfigSpec.BooleanValue SHORT_BOW_AUTO_SHOOT;
    
    public static ForgeConfigSpec.BooleanValue STAKE_CROSSBOW_ALT_SHOOT;
    
    public static ForgeConfigSpec.BooleanValue TRIDENT_USE_CUSTOM_THROW;
    
    public static ForgeConfigSpec.BooleanValue NUNCHAKU_PLAY_SPRINT_SOUND;
    public static ForgeConfigSpec.BooleanValue NUNCHAKU_PLAY_SWING_SOUND;
    
    public static ForgeConfigSpec.BooleanValue SMOKE_BOMB_MECHANIC;
    public static ForgeConfigSpec.DoubleValue SMOKE_BOMB_PUSH_FORCE;
    public static ForgeConfigSpec.DoubleValue SMOKE_BOMB_UPWARD_PUSH_FORCE;
    public static ForgeConfigSpec.BooleanValue SMOKE_BOMB_RESPECT_KNOCKBACK_RESISTANCE;
    public static ForgeConfigSpec.DoubleValue SMOKE_BOMB_SELF_BLIND_PROBABILITY;
    public static ForgeConfigSpec.DoubleValue SMOKE_BOMB_ENEMY_BLIND_PROBABILITY;
    public static ForgeConfigSpec.DoubleValue SMOKE_BOMB_HIT_PROBABILITY;
    public static ForgeConfigSpec.IntValue SMOKE_BOMB_PARTICLE_COUNT;
    public static ForgeConfigSpec.DoubleValue SMOKE_BOMB_PARTICLE_RANGE;
    public static ForgeConfigSpec.IntValue SMOKE_BOMB_COOLDOWN;
    public static ForgeConfigSpec.BooleanValue SMOKE_BOMB_USE_DURABILITY;
    
    public static ForgeConfigSpec.IntValue RAGERS_BOTTLE_USE_DURATION;
    public static ForgeConfigSpec.IntValue RAGERS_BOTTLE_EFFECT_DURATION;
    public static ForgeConfigSpec.IntValue RAGERS_BOTTLE_EFFECT_AMPLIFIER;
    
    public static ForgeConfigSpec.IntValue WARRIORS_BOTTLE_USE_DURATION;
    public static ForgeConfigSpec.IntValue WARRIORS_BOTTLE_EFFECT_DURATION;
    public static ForgeConfigSpec.IntValue WARRIORS_BOTTLE_EFFECT_AMPLIFIER;
    
    public static ForgeConfigSpec.IntValue ARCHERS_BOTTLE_USE_DURATION;
    public static ForgeConfigSpec.IntValue ARCHERS_BOTTLE_EFFECT_DURATION;
    public static ForgeConfigSpec.IntValue ARCHERS_BOTTLE_EFFECT_AMPLIFIER;
    
    public static ForgeConfigSpec.BooleanValue SLINGSHOT_AMMO_FROM_INVENTORY;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> SLINGSHOT_AMMO_ITEMS;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> SLINGSHOT_PLACEABLE_ITEMS;
