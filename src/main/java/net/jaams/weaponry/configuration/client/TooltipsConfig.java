...
public class TooltipsConfig {
    ...
    public static ModConfigSpec.BooleanValue TOOLTIP_ATTACHMENT_PROPERTIES;
    public static ModConfigSpec.BooleanValue TOOLTIP_SLINGSHOT_BASE_AMMO;

    public static ModConfigSpec.BooleanValue TOOLTIP_GUN_CHAMBERS_ROMAN_NUMERALS;
    ...
    public static void register(ModConfigSpec.Builder builder) {
        ...
        TOOLTIP_ATTACHMENT_PROPERTIES = builder.comment("Show attachment properties in attachment tooltips")
