...
public class TooltipsConfig {
    ...
    public static ForgeConfigSpec.BooleanValue CONTROL_TOOLTIPS;
    public static ForgeConfigSpec.BooleanValue ALT_TOOLTIPS;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> EXCLUDED_TOOLTIPS_ITEMS;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> EXCLUDED_CONTROL_TOOLTIPS_ITEMS;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> EXCLUDED_ALT_TOOLTIPS_ITEMS;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_SMOKE_BOMB_PROPERTIES;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_THROWING_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_THROWING_MODE;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_PIERCER_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DUELIST_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_THREAT_RESPONSE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_REACH_ADVANTAGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_AFTER_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_AFTER_STRIKE_HITS;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_AFTER_STRIKE_DAMAGE_MODIFIERS;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_QUICK_CRAFTING_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_AQUATIC_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_ARTHROPOD_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_UNDEAD_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_TRAITOR_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SNOUT_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BONE_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_ANTI_AERIAL_PROPERTIES;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_ROTTEN_GRUDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_ARMOR_BREAKER_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BLADE_BREAKER_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_ACROBATIC_LUNGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DEXTEROUS_LUNGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_PULL_LUNGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DISENGAGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DISARM_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DISMOUNT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DISABLING_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_THROUGH_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_CLEANSING_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_OVERWHELMING_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SUPPRESSING_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SLASH_ASSAULT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_PIERCING_ASSAULT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SMASH_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SHOCK_IMPACT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_HARVEST_SWEEP_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_WILD_SWEEP_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_WHIRLING_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_FRAGILITY_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SLIPPERY_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_EXHAUSTING_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BRITTLE_HANDLE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BARBED_HANDLE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_OVERSTRAIN_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_UNSTABLE_EDGE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DETONATING_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DECAPITATION_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_RAPID_BOOST_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_RAPID_BOOST_HITS;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_POWER_BOOST_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_POWER_BOOST_HITS;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_QUICK_SWAP_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_QUICK_SWAP_MODE;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BUSTER_STRIKE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BUSTER_STRIKE_HITS;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_BACKSTAB_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_GUARD_STANCE_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_PARRY_GUARD_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_HEAVY_HANDED_PROPERTIES;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_BACKSTAB_SHOT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_PIERCING_SHOT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DISABLING_SHOT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SWEEPING_SHOT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_DISARMING_SHOT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_THROWBACK_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_COLLECTOR_PROPERTIES;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_GUN_INVENTORY_HINT;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_GUN_BASE_AMMO;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_GUN_ATTACHMENTS;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_ATTACHMENT_PROPERTIES;
    public static ForgeConfigSpec.BooleanValue TOOLTIP_SLINGSHOT_BASE_AMMO;

    public static ForgeConfigSpec.BooleanValue TOOLTIP_GUN_CHAMBERS_ROMAN_NUMERALS;
    ...
    public static void register(ForgeConfigSpec.Builder builder) {
        ...
        TOOLTIP_ATTACHMENT_PROPERTIES = builder.comment("Show attachment properties in attachment tooltips when holding Alt")
                .define("Show Attachment Properties", true);
        TOOLTIP_GUN_CHAMBERS_ROMAN_NUMERALS = builder.comment("Use roman numerals for gun chamber labels in tooltip")
                .define("Gun Chambers Roman Numerals", true);
        builder.pop();
