...
public class GunSystemClientConfig {
    ...
    public static ForgeConfigSpec.BooleanValue SHOW_GUN_BAR;
    public static ForgeConfigSpec.IntValue GUN_BAR_X;
    public static ForgeConfigSpec.IntValue GUN_BAR_Y;
    public static ForgeConfigSpec.BooleanValue GUN_DEFAULT_COLOR;

    public static ForgeConfigSpec.BooleanValue GUN_DEFAULT_AIMING_POSE;
    public static ForgeConfigSpec.BooleanValue GUN_AIMING_ARM_ANIMATION;
    ...
    public static ForgeConfigSpec.BooleanValue GUN_COOLDOWN_ANIMATION;
    public static ForgeConfigSpec.DoubleValue GUN_COOLDOWN_DROP;
