...
public class ProjectileClientConfig {
	...
	public static ModConfigSpec.DoubleValue AXE_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue CLEAVER_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue RING_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue ROYAL_AXE_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue ROYAL_SPEAR_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue GIANT_SHURIKEN_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue SHURIKEN_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue KUNAI_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue PRONGED_KUNAI_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue SHARP_STONE_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue SPEAR_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue TRIDENT_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue HUNTERS_BOOMERANG_PROJECTILE_SCALE;
	public static ModConfigSpec.BooleanValue HUNTERS_BOOMERANG_PROJECTILE_TRAIL;
	public static ModConfigSpec.IntValue HUNTERS_BOOMERANG_PROJECTILE_TRAIL_SPAWN_RATE;
	
	public static ModConfigSpec.DoubleValue DYNAMITE_PROJECTILE_SCALE;
	public static ModConfigSpec.BooleanValue DYNAMITE_PROJECTILE_TRAIL;
	public static ModConfigSpec.IntValue DYNAMITE_PROJECTILE_TRAIL_SPAWN_RATE;
	
	public static ModConfigSpec.DoubleValue BROOM_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue BULLET_PROJECTILE_SCALE;
	public static ModConfigSpec.BooleanValue BULLET_PROJECTILE_ICON;
	
	public static ModConfigSpec.DoubleValue STAKE_PROJECTILE_SCALE;
	
	public static ModConfigSpec.DoubleValue ITEM_PROJECTILE_SCALE;
