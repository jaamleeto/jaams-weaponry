...
public class AdvancementsHandler {
    ...
    @SubscribeEvent
    public static void onPlayerAdvancementTick(PlayerTickEvent.Post event) {
        if (event.getEntity() instanceof ServerPlayer player) {
    ...
    private static void checkWeaponryAdvancement(ServerPlayer player) {
        AdvancementHolder advancement = player.server.getAdvancements().get(ResourceLocation.fromNamespaceAndPath("jaams_weaponry", "weaponry_ad"));
    ...
    private static void checkHunterAdvancement(ServerPlayer player) {
        AdvancementHolder advancement = player.server.getAdvancements().get(ResourceLocation.fromNamespaceAndPath("jaams_weaponry", "the_hunter"));
        if (advancement == null) {
            return;
        }
    ...
    public static void grantAdvancement(ServerPlayer player, String advancementId) {
        AdvancementHolder advancement = player.server.getAdvancements().get(ResourceLocation.fromNamespaceAndPath("jaams_weaponry", advancementId));
        if (advancement != null) {
