...
public class MobGunShootBehaviorHandler {
    ...
    private static int getGunBaseCooldown(Mob mob) {
        ...
        int result;
        switch (type) {
            case PISTOL: result = GunSystemCommonConfig.GUN_PISTOL_SHOOT_COOLDOWN.get(); break;
            case SCATTERGUN: result = GunSystemCommonConfig.GUN_SCATTERGUN_SHOOT_COOLDOWN.get(); break;
            case SHOTGUN: result = GunSystemCommonConfig.GUN_SHOTGUN_SHOOT_COOLDOWN.get(); break;
