...
public class MobThrowableBehaviorHandler {
    ...
    private static net.jaams.weaponry.component.projectile.BaseWeaponProjectileEntity createProjectileEntity(
        ...
        try {
            ...
            net.jaams.weaponry.component.projectile.BaseWeaponProjectileEntity result;
            switch (upperType) {
                case "AXE": result = new net.jaams.weaponry.entity.AxeProjectileEntity(level, shooter, projectileStack); break;
                case "CLEAVER": result = new net.jaams.weaponry.entity.CleaverProjectileEntity(level, shooter, projectileStack); break;
                case "ROYAL_AXE": result = new net.jaams.weaponry.entity.RoyalAxeProjectileEntity(level, shooter, projectileStack); break;
                case "ROYAL_SPEAR": result = new net.jaams.weaponry.entity.RoyalSpearProjectileEntity(level, shooter, projectileStack); break;
                case "GIANT_SHURIKEN": result = new net.jaams.weaponry.entity.GiantShurikenProjectileEntity(level, shooter, projectileStack); break;
                case "SHURIKEN": result = new net.jaams.weaponry.entity.ShurikenProjectileEntity(level, shooter, projectileStack); break;
                case "KUNAI": result = new net.jaams.weaponry.entity.KunaiProjectileEntity(level, shooter, projectileStack); break;
                case "PRONGED_KUNAI": result = new net.jaams.weaponry.entity.ProngedKunaiProjectileEntity(level, shooter, projectileStack); break;
                case "SHARP_STONE": result = new net.jaams.weaponry.entity.SharpStoneProjectileEntity(level, shooter, projectileStack); break;
                case "SPEAR": result = new net.jaams.weaponry.entity.SpearProjectileEntity(level, shooter, projectileStack); break;
                case "TRIDENT": result = new net.jaams.weaponry.entity.TridentProjectileEntity(level, shooter, projectileStack); break;
                case "HUNTERS_BOOMERANG": case "BOOMERANG": result = new net.jaams.weaponry.entity.HuntersBoomerangProjectileEntity(level, shooter, projectileStack); break;
                case "RING": result = new net.jaams.weaponry.entity.RingProjectileEntity(level, shooter, projectileStack); break;
                case "BROOM": result = new net.jaams.weaponry.entity.BroomProjectileEntity(level, shooter, projectileStack); break;
                case "DYNAMITE": result = new net.jaams.weaponry.entity.DynamiteProjectileEntity(level, shooter, projectileStack); break;
    ...
    private static boolean isThrowable(ItemStack stack) {
        ...
        if (ThrowableModifierLoader.INSTANCE.isThrowableExplicitlyDisabled(stack)) return false;
        java.util.Optional<ThrowableItemData> optData = ThrowableModifierLoader.INSTANCE.getDataForStack(stack);
        if (optData.isPresent()) {
            ThrowableItemData.ThrowableEntry entry = optData.get().throwable;
