...
public class ParryGuardHandler {
    ...
    @SubscribeEvent
    public static void onParryGuardLivingAttack(LivingAttackEvent event) {
        ...
        itemStack.hurtAndBreak(durabilityCost, player, p -> p.broadcastBreakEvent(player.getUsedItemHand()));
