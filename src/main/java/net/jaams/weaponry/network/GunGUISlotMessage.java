...
public class GunGUISlotMessage {
	...
	public static void handler(GunGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JaamsWeaponryMod.addNetworkMessage(GunGUISlotMessage.class, GunGUISlotMessage::buffer, GunGUISlotMessage::new, GunGUISlotMessage::handler);
	}
}
