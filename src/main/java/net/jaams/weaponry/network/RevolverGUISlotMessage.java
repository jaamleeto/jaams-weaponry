...
public class RevolverGUISlotMessage {
	...
	public static void handler(RevolverGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JaamsWeaponryMod.addNetworkMessage(RevolverGUISlotMessage.class, RevolverGUISlotMessage::buffer, RevolverGUISlotMessage::new, RevolverGUISlotMessage::handler);
	}
}
