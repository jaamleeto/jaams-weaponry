...
public class MiniSweepParticleData implements ParticleOptions {

    public static final MapCodec<MiniSweepParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
            ...
            .apply(instance, MiniSweepParticleData::new)
    );

    public static final StreamCodec<RegistryFriendlyByteBuf, MiniSweepParticleData> STREAM_CODEC = StreamCodec.composite(
    ...
    public MiniSweepParticleData(float r, float g, float b, float size) {
    ...
    public ParticleType<?> getType() {
        return ModParticles.MINI_SWEEP_PARTICLE.get();
    }
