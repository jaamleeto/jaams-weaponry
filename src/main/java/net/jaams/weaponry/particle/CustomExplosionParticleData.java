...
public class CustomExplosionParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomExplosionParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomExplosionParticleData> STREAM_CODEC = StreamCodec.composite(
            ...
            CustomExplosionParticleData::new);
