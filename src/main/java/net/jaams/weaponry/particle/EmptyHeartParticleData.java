...
public class EmptyHeartParticleData implements ParticleOptions {
    ...
    public static final MapCodec<EmptyHeartParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, EmptyHeartParticleData> STREAM_CODEC = StreamCodec.composite(
