...
public class CustomSmokeParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomSmokeParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomSmokeParticleData> STREAM_CODEC = StreamCodec.composite(
