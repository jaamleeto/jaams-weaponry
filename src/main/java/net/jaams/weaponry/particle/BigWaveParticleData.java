...
public class BigWaveParticleData implements ParticleOptions {
    ...
    public static final Codec<BigWaveParticleData> CODEC = RecordCodecBuilder.create((instance) -> instance
    ...
    public static final Deserializer<BigWaveParticleData> DESERIALIZER = new Deserializer<>() {
        @Override
        public BigWaveParticleData fromCommand(ParticleType<BigWaveParticleData> type, StringReader reader)
            ...
            return new BigWaveParticleData(r, g, b, size);
        }

        @Override
        public BigWaveParticleData fromNetwork(ParticleType<BigWaveParticleData> type, FriendlyByteBuf buffer) {
            return new BigWaveParticleData(Mth.clamp(buffer.readFloat(), 0.0F, 1.0F),
                    Mth.clamp(buffer.readFloat(), 0.0F, 1.0F), Mth.clamp(buffer.readFloat(), 0.0F, 1.0F),
                    Math.max(buffer.readFloat(), 0.0F));
        }
    };
