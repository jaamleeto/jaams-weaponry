...
public class CustomSweepParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomSweepParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomSweepParticleData> STREAM_CODEC = StreamCodec.composite(
