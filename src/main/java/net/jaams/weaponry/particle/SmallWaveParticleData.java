...
public class SmallWaveParticleData implements ParticleOptions {
    ...
    public static final MapCodec<SmallWaveParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, SmallWaveParticleData> STREAM_CODEC = StreamCodec.composite(
