...
public class CustomHitParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomHitParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomHitParticleData> STREAM_CODEC = StreamCodec.composite(
