...
public class CustomSoulParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomSoulParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomSoulParticleData> STREAM_CODEC = StreamCodec.composite(
