...
public class CustomCritParticleData implements ParticleOptions {

    public static final MapCodec<CustomCritParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
            ...
            .apply(instance, CustomCritParticleData::new)
    );

    public static final StreamCodec<RegistryFriendlyByteBuf, CustomCritParticleData> STREAM_CODEC = StreamCodec.composite(
    ...
    public ParticleType<?> getType() {
        return ModParticles.CUSTOM_CRIT_PARTICLE.get();
    }
