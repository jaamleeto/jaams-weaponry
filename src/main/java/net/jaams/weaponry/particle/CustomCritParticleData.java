...
public class CustomCritParticleData implements ParticleOptions {
    ...
    public static final Codec<CustomCritParticleData> CODEC = RecordCodecBuilder.create((instance) ->
        instance
    ...
    public static final Deserializer<CustomCritParticleData> DESERIALIZER = new Deserializer<>() {
        @Override
