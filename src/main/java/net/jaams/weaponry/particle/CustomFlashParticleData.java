...
public class CustomFlashParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomFlashParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomFlashParticleData> STREAM_CODEC = StreamCodec.composite(
