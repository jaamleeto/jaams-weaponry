...
public class CustomDebuffParticleData implements ParticleOptions {
    ...
    public static final Codec<CustomDebuffParticleData> CODEC = RecordCodecBuilder.create((instance) ->
        instance
    ...
    public static final Deserializer<CustomDebuffParticleData> DESERIALIZER = new Deserializer<>() {
        @Override
        public CustomDebuffParticleData fromCommand(ParticleType<CustomDebuffParticleData> type, StringReader reader) throws CommandSyntaxException {
            reader.expect(' ');
            ...
            return new CustomDebuffParticleData(r, g, b, size);
        }

        @Override
        public CustomDebuffParticleData fromNetwork(ParticleType<CustomDebuffParticleData> type, FriendlyByteBuf buffer) {
            return new CustomDebuffParticleData(buffer.readFloat(), buffer.readFloat(), buffer.readFloat(), buffer.readFloat());
        }
    };
