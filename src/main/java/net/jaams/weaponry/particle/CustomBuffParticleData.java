...
public class CustomBuffParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomBuffParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomBuffParticleData> STREAM_CODEC = StreamCodec.composite(
