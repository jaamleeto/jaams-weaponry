...
public class CustomHeartParticleData implements ParticleOptions {
    ...
    public static final MapCodec<CustomHeartParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CustomHeartParticleData> STREAM_CODEC = StreamCodec.composite(
