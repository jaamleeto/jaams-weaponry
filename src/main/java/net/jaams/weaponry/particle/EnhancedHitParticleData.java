...
public class EnhancedHitParticleData implements ParticleOptions {
    ...
    public static final MapCodec<EnhancedHitParticleData> CODEC = RecordCodecBuilder.mapCodec((instance) ->
        instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, EnhancedHitParticleData> STREAM_CODEC = StreamCodec.composite(
