...
public class SharpStoneProjectileEntity extends BaseWeaponProjectileEntity {

    public SharpStoneProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
        super(ModEntities.SHARP_STONE_PROJECTILE.get(), world);
    }

    public SharpStoneProjectileEntity(EntityType<? extends SharpStoneProjectileEntity> type, Level world) {
        super(type, world);
    }

    public SharpStoneProjectileEntity(EntityType<? extends SharpStoneProjectileEntity> type, double x, double y,
            double z, Level world) {
        super(type, x, y, z, world);
    }

    public SharpStoneProjectileEntity(EntityType<? extends SharpStoneProjectileEntity> type, LivingEntity entity,
            Level world) {
        super(type, entity, world);
    }

    public SharpStoneProjectileEntity(Level world, LivingEntity entity, ItemStack weaponItem) {
        super(ModEntities.SHARP_STONE_PROJECTILE.get(), entity, world, weaponItem);
        initializeProjectileStats(weaponItem);
    }

    @Override
    protected float getDefaultBaseDamage(ItemStack weapon) {
        return ModProjectiles.getBaseDamage(weapon, ProjectileCommonConfig.SHARP_STONE_PROJECTILE_BASE_DAMAGE.get());
    }

    @Override
    protected float getDefaultBaseKnockback(ItemStack weapon) {
        return ModProjectiles.getBaseKnockback(weapon,
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_BASE_KNOCKBACK.get());
    }

    @Override
    protected int getDefaultPierceLevel(ItemStack weapon) {
        return ModProjectiles.getPiercingLevel(weapon,
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_PIERCING_LEVEL.get());
    }

    @Override
    public ItemStack getDefaultWeaponItem() {
        return new ItemStack(ModItems.SHARP_STONE.get());
    }

    @Override
    public EntityDimensions getDimensions(Pose pose) {
        return ModProjectiles.getDimensions(this.getWeaponItem(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_HITBOX_WIDTH.get().floatValue(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_HITBOX_HEIGHT.get().floatValue());
    }

    @Override
    protected SoundEvent getHitSound() {
        return ModProjectiles.getCustomProjectileSound(this.getWeaponItem(), "ProjectileHitSound", "projectile_hit",
                "sharp_stone_hit", SoundEvents.TRIDENT_HIT, (projectileEntry) -> projectileEntry.hit_sound);
    }
    ...
    protected SoundEvent getGroundSound() {
        return ModProjectiles.getCustomProjectileSound(this.getWeaponItem(), "ProjectileGroundSound",
                "projectile_ground", "sharp_stone_ground", SoundEvents.TRIDENT_HIT_GROUND,
    ...
    protected SoundEvent getLoyaltySound() {
        return ModProjectiles.getCustomProjectileSound(this.getWeaponItem(), "ProjectileReturnSound",
                "projectile_return", "sharp_stone_return", SoundEvents.TRIDENT_RETURN,
    ...
    public boolean canDisableShield(ItemStack shield, LivingEntity shieldHolder, Entity owner) {
        return ModProjectiles.canDisableShield(this.getWeaponItem(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_DISABLE_SHIELD.get());
    }
    ...
    protected float getWaterInertia() {
        return ModProjectiles.getWaterInertia(this.getWeaponItem(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_WATER_INERTIA.get());
    }

    @Override
    public boolean isCritical() {
        if (!ModProjectiles.getAllowCriticals(this.getWeaponItem(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_ALLOW_CRITICALS.get())) {
            return false;
        }
    ...
    public int getIgnoreHitTicks() {
        return ModProjectiles.getIgnoreHitTicks(this.getWeaponItem(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_IGNORE_TICKS.get());
    }
    ...
    protected void tickDespawn() {
        ...
        int despawnTime = ModProjectiles.getDespawnTicks(this.getWeaponItem(),
                ProjectileCommonConfig.SHARP_STONE_PROJECTILE_DESPAWN_TIME.get());
        if (life >= despawnTime) {
            if (ProjectileCommonConfig.SHARP_STONE_PROJECTILE_DESPAWN_AS_ITEM.get()
