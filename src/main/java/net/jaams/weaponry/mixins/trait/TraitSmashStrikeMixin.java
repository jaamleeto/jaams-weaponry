...
public class TraitSmashStrikeMixin {
    ...
    private void jaams$onSmashStrikeHurtEnemy(LivingEntity target, Player attacker, CallbackInfo ci) {
    ...
    private void applySmashLogic(LivingEntity attacker, LivingEntity target, ItemStack stack, float attackStrength,
        ...
        level.playSound(null, attacker.getX(), attacker.getY(), attacker.getZ(),
                SoundEvents.GENERIC_EXPLODE, attacker instanceof Player ? SoundSource.PLAYERS : SoundSource.HOSTILE,
        ...
        if (!(attacker instanceof Player player && player.isCreative())) {
            ...
            if (durabilityDamage > 0) {
                stack.hurtAndBreak(durabilityDamage, attacker, (e) -> e.broadcastBreakEvent(EquipmentSlot.MAINHAND));
            }
        }
    }
