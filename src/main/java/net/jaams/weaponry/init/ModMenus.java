...
public class ModMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<PepperboxGUIMenu>> PEPPERBOX_GUI = REGISTRY.register("pepperbox_gui", () -> IMenuTypeExtension.create(PepperboxGUIMenu::new));
