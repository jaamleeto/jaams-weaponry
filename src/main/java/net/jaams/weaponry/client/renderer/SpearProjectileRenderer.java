...
public class SpearProjectileRenderer extends EntityRenderer<SpearProjectileEntity> {
    ...
    @Override
    public void render(SpearProjectileEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack,
        ...
        float scale = data.getFloat("ProjectileScale", (render != null && render.scale != null) ? render.scale
                : ProjectileClientConfig.SPEAR_PROJECTILE_SCALE.get().floatValue());
        ...
        float offsetY = data.getFloat("ProjectileOffsetY",
                (render != null && render.offset_y != null) ? render.offset_y : -1.45f);
        ...
        matrixStack.mulPose(Axis.YP.rotationDegrees(Mth.lerp(partialTicks, entity.yRotO, entity.getYRot()) + rotY));
        matrixStack.mulPose(
                Axis.XP.rotationDegrees(Mth.lerp(partialTicks, entity.xRotO, entity.getXRot()) + rotX + pitchOffset));
