...
public class ShurikenProjectileRenderer extends EntityRenderer<ShurikenProjectileEntity> {
    ...
    @Override
    public void render(ShurikenProjectileEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack,
        ...
        float scale = data.getFloat("ProjectileScale", (render != null && render.scale != null) ? render.scale
                : ProjectileClientConfig.SHURIKEN_PROJECTILE_SCALE.get().floatValue());
        ...
        float baseZRotation = data.getFloat("ProjectileBaseZRotation",
                (render != null && render.base_z_rotation != null) ? render.base_z_rotation : 105.0f);
