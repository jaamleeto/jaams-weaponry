...
public class KunaiProjectileRenderer extends EntityRenderer<KunaiProjectileEntity> {
    ...
    @Override
    public void render(KunaiProjectileEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack,
        ...
        float scale = data.getFloat("ProjectileScale", (render != null && render.scale != null) ? render.scale
                : ProjectileClientConfig.KUNAI_PROJECTILE_SCALE.get().floatValue());
    ...
    @Override
    public ResourceLocation getTextureLocation(KunaiProjectileEntity entity) {
