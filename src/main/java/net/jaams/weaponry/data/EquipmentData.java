...
public class EquipmentData {
    ...
    public static class ItemEntry {
        ...
        public net.minecraft.world.entity.EquipmentSlot getEquipmentSlot() {
            ...
            switch (slot.toLowerCase(java.util.Locale.ROOT)) {
                case "offhand":
                    result = net.minecraft.world.entity.EquipmentSlot.OFFHAND;
                    break;
                case "head":
                    result = net.minecraft.world.entity.EquipmentSlot.HEAD;
                    break;
                case "chest":
                    result = net.minecraft.world.entity.EquipmentSlot.CHEST;
                    break;
                case "legs":
                    result = net.minecraft.world.entity.EquipmentSlot.LEGS;
                    break;
                case "feet":
                    result = net.minecraft.world.entity.EquipmentSlot.FEET;
                    break;
                default:
                    result = net.minecraft.world.entity.EquipmentSlot.MAINHAND;
                    break;
            }
            return result;
        }
