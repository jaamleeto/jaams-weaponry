...
public final class ModProjectiles {
    public static SoundEvent getCustomProjectileSound(ItemStack weapon, String nbtKey, String genericId,
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains(nbtKey, net.minecraft.nbt.Tag.TAG_STRING)) {
            String soundId = ModComponents.get(weapon).getString(nbtKey);
            SoundEvent custom = BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse(soundId));
            if (custom != null)
                return custom;
        }
        if (weapon != null) {
            ...
            if (dataOpt.isPresent()) {
                ...
                if (projConfig != null) {
                    ...
                    if (jsonSoundId != null && !jsonSoundId.isEmpty()) {
                        SoundEvent jsonSound = BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse(jsonSoundId));
                        if (jsonSound != null)
                            return jsonSound;
                    }
                }
        ...
        SoundEvent modSound = BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("jaams_weaponry:" + soundId));
        if (modSound != null)
            return modSound;
    ...
    public static int getMultishotCloneDespawnTicks(ItemStack weapon) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("MultishotCloneDespawnTicks", 3)) {
            return ModComponents.get(weapon).getInt("MultishotCloneDespawnTicks");
        }
    ...
    public static ParticleOptions getTrailParticle(ItemStack weapon, ParticleOptions defaultParticle) {
        ...
        CompoundTag tag = ModComponents.getOrCreate(weapon);
    ...
    public static boolean useGenericProjectileSounds(ItemStack weapon) {
        return weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).getBoolean("ProjectileGenericSoundSet");
    }

    public static float getBaseDamage(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileBaseDamage", Tag.TAG_FLOAT)) {
            return ModComponents.get(weapon).getFloat("ProjectileBaseDamage");
        }
        return (float) configDefault;
    }

    public static float getBaseKnockback(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileBaseKnockback", Tag.TAG_FLOAT)) {
            return ModComponents.get(weapon).getFloat("ProjectileBaseKnockback");
        }
        return (float) configDefault;
    }
    ...
    public static int getPiercingLevel(ItemStack weapon, int configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectilePiercingLevel", Tag.TAG_INT)) {
            level = Math.max(0, ModComponents.get(weapon).getInt("ProjectilePiercingLevel"));
        }
        level += ModEnchantments.level(weapon, Enchantments.PIERCING);
        return Math.max(0, level);
    }

    public static int getDespawnTicks(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileDespawnTicks", 99)) {
            return Math.max(1, ModComponents.get(weapon).getInt("ProjectileDespawnTicks"));
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static float getWaterInertia(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileWaterInertia", 99)) {
            return ModComponents.get(weapon).getFloat("ProjectileWaterInertia");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static boolean getAllowCriticals(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileAllowCriticals", 1)) {
            return ModComponents.get(weapon).getBoolean("ProjectileAllowCriticals");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static int getIgnoreHitTicks(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileIgnoreHitTicks", 99)) {
            return Math.max(0, ModComponents.get(weapon).getInt("ProjectileIgnoreHitTicks"));
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static boolean shouldBreakOnEntityHit(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileBreakOnEntityHit", 1)) {
            return ModComponents.get(weapon).getBoolean("ProjectileBreakOnEntityHit");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static boolean shouldBreakOnBlockHit(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileBreakOnBlockHit", 1)) {
            return ModComponents.get(weapon).getBoolean("ProjectileBreakOnBlockHit");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static boolean shouldBreakOnPiercingExhausted(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileBreakOnPiercingExhausted", 1)) {
            return ModComponents.get(weapon).getBoolean("ProjectileBreakOnPiercingExhausted");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static boolean shouldBreakAfterMaxBlockBreaks(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileBreakAfterMaxBlockBreaks", 1)) {
            return ModComponents.get(weapon).getBoolean("ProjectileBreakAfterMaxBlockBreaks");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static int getMaxBlockBreaks(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileMaxBlockBreaks", 99)) {
            return Math.max(0, ModComponents.get(weapon).getInt("ProjectileMaxBlockBreaks"));
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static boolean canDisableShield(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileDisableShield", 1)) {
            return ModComponents.get(weapon).getBoolean("ProjectileDisableShield");
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static int getShieldDisableCooldownTicks(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileDisableCooldownTicks", 99)) {
            return Math.max(20, ModComponents.get(weapon).getInt("ProjectileDisableCooldownTicks"));
        }
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
    ...
    public static int getMaxTicksInAir(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("BulletMaxTicksInAir", Tag.TAG_INT)) {
            return Math.max(0, ModComponents.get(weapon).getInt("BulletMaxTicksInAir"));
        }
        return configDefault;
    }

    public static int getMaxTicksInGround(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("BulletMaxTicksInGround", Tag.TAG_INT)) {
            return Math.max(0, ModComponents.get(weapon).getInt("BulletMaxTicksInGround"));
        }
        return configDefault;
    }

    public static int getColor(ItemStack weapon, ModConfigSpec.ConfigValue<String> configColor) {
        if (weapon != null && ModComponents.has(weapon)) {
            CompoundTag tag = ModComponents.get(weapon);
    ...
    public static int getNoGravityDuration(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("BulletNoGravityDuration", Tag.TAG_INT)) {
            return Math.max(0, ModComponents.get(weapon).getInt("BulletNoGravityDuration"));
        }
        return configDefault;
    }

    public static boolean hasInitialNoGravity(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("BulletInitialNoGravity", Tag.TAG_BYTE)) {
            return ModComponents.get(weapon).getBoolean("BulletInitialNoGravity");
        }
        return configDefault;
    }
    ...
    public static EntityDimensions getDimensions(ItemStack weapon, float defaultWidth, float defaultHeight) {
        ...
        ThrowableItemData.ProjectileEntry config = ThrowableItemData.getProjectileConfig(weapon);
        if (config != null && config.hitbox_width != null) {
            width = config.hitbox_width;
        }
        if (config != null && config.hitbox_height != null) {
    ...
    public static boolean getPiercingShotEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("PiercingShotTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("PiercingShotTrait");
        }
    ...
    public static boolean getBackstabShotEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("BackstabShotTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("BackstabShotTrait");
        }
    ...
    public static boolean getSweepingShotEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("SweepingShotTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("SweepingShotTrait");
        }
    ...
    public static boolean getDisarmingShotEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisarmingShotTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("DisarmingShotTrait");
        }
    ...
    public static boolean getDisablingShotEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisablingShotTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("DisablingShotTrait");
        }
    ...
    public static boolean getCollectorEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("CollectorTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("CollectorTrait");
        }
    ...
    public static boolean getThrowbackEnabled(ItemStack weapon, boolean configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ThrowbackTrait", 1)) {
            return ModComponents.get(weapon).getBoolean("ThrowbackTrait");
        }
    ...
    public static boolean getReturnOnBlockHit(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ThrowbackReturnOnBlockHit", 1)) {
            return ModComponents.get(weapon).getBoolean("ThrowbackReturnOnBlockHit");
        }
        Optional<TraitModifierData.ThrowbackEntry> trait = TraitModifierData.getThrowback(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static boolean getReturnOnEntityHit(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ThrowbackReturnOnEntityHit", 1)) {
            return ModComponents.get(weapon).getBoolean("ThrowbackReturnOnEntityHit");
        }
        Optional<TraitModifierData.ThrowbackEntry> trait = TraitModifierData.getThrowback(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static boolean getReturnOnMaxRange(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ThrowbackReturnOnMaxRange", 1)) {
            return ModComponents.get(weapon).getBoolean("ThrowbackReturnOnMaxRange");
        }
        Optional<TraitModifierData.ThrowbackEntry> trait = TraitModifierData.getThrowback(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static double getThrowbackMinRange(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileMinRange", Tag.TAG_DOUBLE)) {
            return ModComponents.get(weapon).getDouble("ProjectileMinRange");
        }
        Optional<TraitModifierData.ThrowbackEntry> trait = TraitModifierData.getThrowback(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static float getThrowbackMaxRange(ItemStack weapon, float configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileMaxRange", Tag.TAG_FLOAT)) {
            return ModComponents.get(weapon).getFloat("ProjectileMaxRange");
        }
        Optional<TraitModifierData.ThrowbackEntry> trait = TraitModifierData.getThrowback(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static double getThrowbackReturnSpeed(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileReturnSpeed", Tag.TAG_DOUBLE)) {
            return ModComponents.get(weapon).getDouble("ProjectileReturnSpeed");
        }
        Optional<TraitModifierData.ThrowbackEntry> trait = TraitModifierData.getThrowback(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static int getMaxMountedEntities(ItemStack weapon, boolean collectorEnabled, int configDefault) {
        ...
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("CollectorMaxMountedEntities", 3)) {
            return ModComponents.get(weapon).getInt("CollectorMaxMountedEntities");
        }
        Optional<TraitModifierData.CollectorEntry> trait = TraitModifierData.getCollector(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static int getMaxBounces(ItemStack weapon, ModConfigSpec.IntValue defaultConfig) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileMaxBounces", 99)) {
            return Math.max(0, ModComponents.get(weapon).getInt("ProjectileMaxBounces"));
        }
        if (weapon != null) {
            Optional<ThrowableItemData> dataOpt = ThrowableItemData.getData(weapon);
    ...
    public static boolean getSwooshSoundEnabled(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileSwooshSound", Tag.TAG_BYTE)) {
            return ModComponents.get(weapon).getBoolean("ProjectileSwooshSound");
        }
        if (weapon != null) {
            Optional<ThrowableItemData> dataOpt = ThrowableItemData.getData(weapon);
            if (dataOpt.isPresent() && dataOpt.get().projectile != null) {
    ...
    public static int getSwooshInterval(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("ProjectileSwooshInterval", Tag.TAG_INT)) {
            return Math.max(1, ModComponents.get(weapon).getInt("ProjectileSwooshInterval"));
        }
        if (weapon != null) {
            Optional<ThrowableItemData> dataOpt = ThrowableItemData.getData(weapon);
            if (dataOpt.isPresent() && dataOpt.get().projectile != null) {
    ...
    public static String getSwooshSoundId(ItemStack weapon, String defaultSound) {
        if (weapon != null && !weapon.isEmpty() && ModComponents.has(weapon)) {
            CompoundTag tag = ModComponents.get(weapon);
    ...
    public static boolean getIgniteBlocks(ItemStack gun, boolean defaultValue) {
        if (gun != null && ModComponents.has(gun)) {
            CompoundTag tag = ModComponents.get(gun);
    ...
    public static float getDisarmingShotChance(ItemStack weapon, float configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisarmingShotChance", 5)) {
            return ModComponents.get(weapon).getFloat("DisarmingShotChance");
        }
        Optional<TraitModifierData.DisarmingShotEntry> trait = TraitModifierData.getDisarmingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static boolean getDisarmingShotRequireCritical(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisarmingShotRequireCritical", 1)) {
            return ModComponents.get(weapon).getBoolean("DisarmingShotRequireCritical");
        }
        Optional<TraitModifierData.DisarmingShotEntry> trait = TraitModifierData.getDisarmingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static boolean getDisarmingShotMountItem(ItemStack weapon, boolean configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisarmingShotMountItem", 1)) {
            return ModComponents.get(weapon).getBoolean("DisarmingShotMountItem");
        }
        Optional<TraitModifierData.DisarmingShotEntry> trait = TraitModifierData.getDisarmingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static float getDisablingShotChance(ItemStack weapon, float configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisablingShotChance", 5)) {
            return ModComponents.get(weapon).getFloat("DisablingShotChance");
        }
        Optional<TraitModifierData.DisablingShotEntry> trait = TraitModifierData.getDisablingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
            return trait.get().chance;
    ...
    public static int getDisablingShotCooldown(ItemStack weapon, int configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("DisablingShotCooldown", 3)) {
            return ModComponents.get(weapon).getInt("DisablingShotCooldown");
        }
        Optional<TraitModifierData.DisablingShotEntry> trait = TraitModifierData.getDisablingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static double getSweepingShotRadius(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("SweepingRadius", 99)) {
            return ModComponents.get(weapon).getDouble("SweepingRadius");
        }
        Optional<TraitModifierData.SweepingShotEntry> trait = TraitModifierData.getSweepingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static double getSweepingShotDamageFactor(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("SweepingDamageFactor", 99)) {
            return ModComponents.get(weapon).getDouble("SweepingDamageFactor");
        }
        Optional<TraitModifierData.SweepingShotEntry> trait = TraitModifierData.getSweepingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static double getBackstabShotDamageMultiplier(ItemStack weapon, double defaultValue) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("BackstabMultiplier", 99)) {
            return ModComponents.get(weapon).getDouble("BackstabMultiplier");
        }
        Optional<TraitModifierData.BackstabShotEntry> trait = TraitModifierData.getBackstabShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    public static double getPiercingShotChance(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("PiercingShotChance", Tag.TAG_DOUBLE)) {
            return ModComponents.get(weapon).getDouble("PiercingShotChance");
        }
        Optional<TraitModifierData.PiercingShotEntry> trait = TraitModifierData.getPiercingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
            return trait.get().chance;
    ...
    public static double getPiercingShotBonusDamage(ItemStack weapon, double configDefault) {
        if (weapon != null && ModComponents.has(weapon) && ModComponents.get(weapon).contains("PiercingShotBonusDamage", Tag.TAG_DOUBLE)) {
            return ModComponents.get(weapon).getDouble("PiercingShotBonusDamage");
        }
        Optional<TraitModifierData.PiercingShotEntry> trait = TraitModifierData.getPiercingShot(weapon);
        if (trait.isPresent() && trait.get() != null) {
    ...
    private static boolean hasBoolean(ItemStack stack, String key) {
        return ModComponents.has(stack) && ModComponents.get(stack).contains(key, Tag.TAG_BYTE);
    }

    private static boolean hasInt(ItemStack stack, String key) {
        return ModComponents.has(stack) && ModComponents.get(stack).contains(key, Tag.TAG_INT);
    }

    private static boolean hasFloat(ItemStack stack, String key) {
        return ModComponents.has(stack) && ModComponents.get(stack).contains(key, 99);
    }
    ...
    public static void initializeWeaponItem(Entity projectile, ItemStack weaponItem, ItemStack defaultItem,
        ...
        persistentData.put("WeaponItem", toSet.saveOptional(projectile.registryAccess()));
    }
    ...
    public static void updateWeaponEnchantmentData(Entity projectile, ItemStack weaponItem,
        ...
        projectile.getEntityData().set(loyaltyAccessor, (byte) ModEnchantments.level(weaponItem, net.minecraft.world.item.enchantment.Enchantments.LOYALTY));
    ...
    public static float getItemAttackDamage(ItemStack itemStack) {
        ...
        double total = ModUtils.attackDamageModifierSum(itemStack, EquipmentSlot.MAINHAND);
        if (total <= 0.0) {
            total = ModUtils.attackDamageModifierSum(itemStack, EquipmentSlot.OFFHAND);
        }
    ...
    public static void damageShield(ItemStack shield, LivingEntity holder, int damageAmount) {
        if (shield.isDamageableItem()) {
            shield.hurtAndBreak(damageAmount, holder, LivingEntity.getSlotForHand(holder.getUsedItemHand()));
        }
    }
    ...
    public static void spawnEnchantedHitEffects(ServerLevel level, LivingEntity hitLivingEntity, ItemStack weaponItem) {
        int sharpness = ModEnchantments.level(weaponItem, Enchantments.SHARPNESS);
        int smite = ModEnchantments.level(weaponItem, Enchantments.SMITE);
        int bane = ModEnchantments.level(weaponItem, Enchantments.BANE_OF_ARTHROPODS);
    ...
    public static void applyWeaponEnchantmentEffects(LivingEntity target, @Nullable Entity owner,
        ...
        if (owner instanceof LivingEntity ownerLiving) {
            net.jaams.weaponry.util.ModUtils.applyAttackEnchantEffects(target, ownerLiving);
        }
        int fireAspectLevel = ModEnchantments.level(weaponItem, Enchantments.FIRE_ASPECT);
