...
public class ModTags {
    ...
    public static final TagKey<Item> PEPPERBOXES = create("item/pepperboxes");
    ...
    public static final TagKey<Item> ATTACHMENTS = create("misc/attachments");
    ...
    public static final TagKey<Item> AIM_POSE = create("pose/aim_pose");
