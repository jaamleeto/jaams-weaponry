...
public class ModAnimations {
    ...
    public static void playAnimation(ServerPlayer target, String animationName, boolean override, boolean firstPerson) {
        ...
        PacketDistributor.sendToPlayer(target, new PlayAnimationMessage(target.getId(), animationName, override, firstPerson));
    }
    ...
    public static void stopAnimation(ServerPlayer target) {
        if (target == null)
            return;
        PacketDistributor.sendToPlayer(target, new PlayAnimationMessage(target.getId(), "", false, false));
    }
    ...
    public static void playAnimationForTracking(ServerPlayer target, String animationName, boolean override,
        ...
        if (target == null || animationName == null || animationName.isEmpty())
            return;
        animationName = resolveRandomGroup(animationName);
        PacketDistributor.sendToPlayersTrackingEntity(target, new PlayAnimationMessage(target.getId(), animationName, override, firstPerson));
    }

    public static void stopAnimationForTracking(ServerPlayer target) {
        if (target == null)
            return;
        PacketDistributor.sendToPlayersTrackingEntity(target, new PlayAnimationMessage(target.getId(), "", false, false));
    }
    ...
    public static void playMobAnimation(LivingEntity entity, String animationName, boolean override, float speed,
        ...
        if (entity == null || animationName == null || animationName.isEmpty())
            return;
        PacketDistributor.sendToPlayersTrackingEntity(entity, new PlayMobAnimationMessage(entity.getId(), animationName, override, duration, speed));
        
        if (entity instanceof ServerPlayer player) {
            PacketDistributor.sendToPlayer(player, new PlayMobAnimationMessage(entity.getId(), animationName, override, duration, speed));
        }
    }
    ...
    public static void stopMobAnimation(LivingEntity entity) {
        if (entity == null)
            return;
        PacketDistributor.sendToPlayersTrackingEntity(entity, new PlayMobAnimationMessage(entity.getId(), "", true));
        if (entity instanceof ServerPlayer player) {
            PacketDistributor.sendToPlayer(player, new PlayMobAnimationMessage(entity.getId(), "", true));
        }
    }
    ...
    public static void playMobAnimationFor(ServerPlayer receiver, LivingEntity target, String animationName,
        ...
        if (receiver == null || target == null || animationName == null || animationName.isEmpty())
            return;
        PacketDistributor.sendToPlayer(receiver, new PlayMobAnimationMessage(target.getId(), animationName, override, duration, speed));
    }
                    ...
                    if (!particleId.isEmpty()) {
                        ...
                        if (particle == null) {
                            ...
                            var opt = BuiltInRegistries.PARTICLE_TYPE
                                    .getOptional(ResourceLocation.parse(particleId));
                            if (opt.isPresent()
