...
public class ModItemProperties {
    ...
    private static float handlePlayerNunchaku(Player player, ItemStack stack) {
        ...
        boolean isHoldingNunchaku = ItemStack.matches(player.getMainHandItem(), stack) || ItemStack.matches(player.getOffhandItem(), stack);
        boolean isSwinging = player.swingTime > 0 &&
                player.swingingArm != null &&
                ((player.swingingArm == InteractionHand.MAIN_HAND && ItemStack.matches(player.getMainHandItem(), stack))
                        || (player.swingingArm == InteractionHand.OFF_HAND && ItemStack.matches(player.getOffhandItem(), stack)))
                &&
        ...
        boolean isActiveItem = ItemStack.matches(player.getUseItem(), stack) || isNunchakuTagItem(player.getUseItem().getItem())
    ...
    private static float handleMobNunchaku(Mob mob, ItemStack stack) {
        ...
        boolean isHoldingNunchaku = ItemStack.matches(mob.getMainHandItem(), stack) || ItemStack.matches(mob.getOffhandItem(), stack);
        boolean isSwinging = mob.swingTime > 0 && mob.swingingArm != null
                && ((mob.swingingArm == InteractionHand.MAIN_HAND && ItemStack.matches(mob.getMainHandItem(), stack))
                        || (mob.swingingArm == InteractionHand.OFF_HAND && ItemStack.matches(mob.getOffhandItem(), stack)));
        ...
        boolean isActive = isHoldingNunchaku && ((mob.isUsingItem()
                && (ItemStack.matches(mob.getUseItem(), stack) || isNunchakuTagItem(mob.getUseItem().getItem())))
