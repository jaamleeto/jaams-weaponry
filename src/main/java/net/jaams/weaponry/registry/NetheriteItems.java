...
public class NetheriteItems {
	...
	public static final DeferredHolder<Item, Item> HEAVY_NETHERITE_INGOT = REGISTRY.register("heavy_netherite_ingot", () -> new Item(new Item.Properties()));
	public static final DeferredHolder<Item, Item> DOUBLE_NETHERITE_INGOT = REGISTRY.register("double_netherite_ingot", () -> new Item(new Item.Properties()));
	...
	public static final DeferredHolder<Item, Item> NETHERITE_DAGGER_REVERSE = REGISTRY.register("netherite_dagger_reverse",
			() -> TieredWeapons.sword(1931, 9f, 0.5f, 4, 15, Ingredient.of(new ItemStack(Items.NETHERITE_INGOT)), 3, -1.4f));
	public static final DeferredHolder<Item, Item> NETHERITE_KNUCKLE = REGISTRY.register("netherite_knuckle",
			() -> TieredWeapons.sword(1931, 9f, 1.5f, 4, 15, Ingredient.of(new ItemStack(Items.NETHERITE_INGOT)), 3, -1.6f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_CLEAVER = REGISTRY.register("netherite_cleaver",
	...
	public static final DeferredHolder<Item, Item> NETHERITE_KAMA = REGISTRY.register("netherite_kama",
	...
	public static final DeferredHolder<Item, Item> NETHERITE_MACHETE = REGISTRY.register("netherite_machete",
			() -> TieredWeapons.sword(2031, 9f, 3.5f, 4, 15, Ingredient.of(new ItemStack(Items.NETHERITE_INGOT)), 3, -2.5f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_KATAR = REGISTRY.register("netherite_katar",
			() -> TieredWeapons.sword(2031, 9f, 4f, 4, 15, Ingredient.of(new ItemStack(Items.NETHERITE_INGOT)), 3, -2.6f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_SICKLE = REGISTRY.register("netherite_sickle",
	...
	public static final DeferredHolder<Item, Item> NETHERITE_BUTTERFLY_SWORD = REGISTRY.register("netherite_butterfly_sword",
			() -> TieredWeapons.sword(2031, 9f, 5f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -2.6f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_GREATSWORD = REGISTRY.register("netherite_greatsword",
	...
	public static final DeferredHolder<Item, Item> NETHERITE_HOOK_SWORD = REGISTRY.register("netherite_hook_sword",
	...
	public static final DeferredHolder<Item, Item> NETHERITE_LONGSWORD = REGISTRY.register("netherite_longsword",
			() -> TieredWeapons.sword(2131, 9f, 6f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -2.9f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_SAW_CLEAVER = REGISTRY.register("netherite_saw_cleaver",
			() -> TieredWeapons.sword(2031, 9f, 6.5f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -2.6f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_SAW_CLEAVER_UNFOLDED = REGISTRY.register("netherite_saw_cleaver_unfolded",
			() -> TieredWeapons.sword(2031, 9f, 5.5f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -2.8f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_SCYTHE = REGISTRY.register("netherite_scythe",
			() -> TieredWeapons.sword(2031, 9f, 7f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -3.1f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_TWINBLADE = REGISTRY.register("netherite_twinblade",
			() -> TieredWeapons.sword(2031, 9f, 4f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -2.2f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_ZWEIHANDER = REGISTRY.register("netherite_zweihander",
			() -> TieredWeapons.sword(2131, 9f, 6f, 4, 15, Ingredient.of(new ItemStack(ModItems.DOUBLE_NETHERITE_INGOT.get())), 3, -3.1f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_BUSTER_SWORD = REGISTRY.register("netherite_buster_sword",
			() -> TieredWeapons.sword(2231, 9f, 10f, 4, 15, Ingredient.of(new ItemStack(ModItems.HEAVY_NETHERITE_INGOT.get())), 3, -3.4f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_GREATHAMMER = REGISTRY.register("netherite_greathammer",
			() -> TieredWeapons.pickaxe(2331, 9f, 12f, 4, 15, Ingredient.of(new ItemStack(ModItems.HEAVY_NETHERITE_INGOT.get())), 3, -3.6f, true));
	public static final DeferredHolder<Item, Item> NETHERITE_SHOTGUN = REGISTRY.register("netherite_shotgun",
