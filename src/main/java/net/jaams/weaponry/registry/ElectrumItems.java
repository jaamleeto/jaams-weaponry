...
public class ElectrumItems {
    ...
    public static final RegistryObject<Item> HEAVY_ELECTRUM_INGOT = REGISTRY.register("heavy_electrum_ingot",
            () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DOUBLE_ELECTRUM_INGOT = REGISTRY.register("double_electrum_ingot",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ELECTRUM_BROADSWORD = REGISTRY.register("electrum_broadsword",
            () -> TieredWeapons.sword(2040, 10f, 7f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ELECTRUM_INGOT.get())), 3, -2.8f));
    public static final RegistryObject<Item> ELECTRUM_BUTTERFLY_SWORD = REGISTRY.register("electrum_butterfly_sword",
    ...
    public static final RegistryObject<Item> ELECTRUM_HAMMER = REGISTRY.register("electrum_hammer",
            () -> TieredWeapons.pickaxe(2120, 10f, 9f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ELECTRUM_INGOT.get())), 3, -3.4f));
    public static final RegistryObject<Item> ELECTRUM_HOOK_SWORD = REGISTRY.register("electrum_hook_sword",
    ...
    public static final RegistryObject<Item> ELECTRUM_LONGSWORD = REGISTRY.register("electrum_longsword",
            () -> TieredWeapons.sword(2020, 10f, 7f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ELECTRUM_INGOT.get())), 3, -2.9f));
    public static final RegistryObject<Item> ELECTRUM_SAW_CLEAVER = REGISTRY.register("electrum_saw_cleaver",
            () -> TieredWeapons.sword(1920, 10f, 7.5f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ELECTRUM_INGOT.get())), 3, -2.6f));
    public static final RegistryObject<Item> ELECTRUM_SAW_CLEAVER_UNFOLDED = REGISTRY.register(
    ...
    public static final RegistryObject<Item> ELECTRUM_TWINBLADE = REGISTRY.register("electrum_twinblade",
            () -> TieredWeapons.sword(1920, 10f, 5f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ELECTRUM_INGOT.get())), 3, -2.2f));
    public static final RegistryObject<Item> ELECTRUM_ZWEIHANDER = REGISTRY.register("electrum_zweihander",
            () -> TieredWeapons.sword(2040, 10f, 7f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ELECTRUM_INGOT.get())), 3, -3.1f));
    public static final RegistryObject<Item> ELECTRUM_BUSTER_SWORD = REGISTRY.register("electrum_buster_sword",
            () -> TieredWeapons.sword(2120, 10f, 11f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.HEAVY_ELECTRUM_INGOT.get())), 3, -3.4f));
    public static final RegistryObject<Item> ELECTRUM_GREATHAMMER = REGISTRY.register("electrum_greathammer",
            () -> TieredWeapons.pickaxe(2220, 10f, 13f, 4, 18,
                    Ingredient.of(new ItemStack(ModItems.HEAVY_ELECTRUM_INGOT.get())), 3, -3.6f));
    public static final RegistryObject<Item> ELECTRUM_SHOTGUN = REGISTRY.register("electrum_shotgun",
