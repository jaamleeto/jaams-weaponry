...
public class StoneItems {
    ...
    public static final RegistryObject<Item> HEAVY_COMPRESSED_STONE = REGISTRY.register("heavy_compressed_stone",
            () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DOUBLE_COMPRESSED_STONE = REGISTRY.register("double_compressed_stone",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> STONE_BUTTERFLY_SWORD = REGISTRY.register("stone_butterfly_sword",
    ...
    public static final RegistryObject<Item> STONE_SCYTHE = REGISTRY.register("stone_scythe",
            () -> TieredWeapons.sword(131, 4f, 4f, 1, 5,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_COMPRESSED_STONE.get())), 3, -3.1f));
    public static final RegistryObject<Item> STONE_TWINBLADE = REGISTRY.register("stone_twinblade",
            () -> TieredWeapons.sword(131, 4f, -2f, 1, 5,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_COMPRESSED_STONE.get())), 3, -2.2f));
    public static final RegistryObject<Item> STONE_SAW_CLEAVER = REGISTRY.register("stone_saw_cleaver",
            () -> TieredWeapons.sword(131, 4f, 3.5f, 1, 5,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_COMPRESSED_STONE.get())), 3, -2.6f));
    public static final RegistryObject<Item> STONE_SAW_CLEAVER_UNFOLDED = REGISTRY.register(
