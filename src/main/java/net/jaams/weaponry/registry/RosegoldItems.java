...
public class RosegoldItems {
    ...
    public static final RegistryObject<Item> HEAVY_ROSEGOLD_INGOT = REGISTRY.register("heavy_rosegold_ingot",
            () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DOUBLE_ROSEGOLD_INGOT = REGISTRY.register("double_rosegold_ingot",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ROSEGOLD_BROADSWORD = REGISTRY.register("rosegold_broadsword",
            () -> TieredWeapons.sword(1681, 8, 5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.8f));
    public static final RegistryObject<Item> ROSEGOLD_BUTTERFLY_SWORD = REGISTRY.register("rosegold_butterfly_sword",
            () -> TieredWeapons.sword(1561, 8, 4f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.6f));
    public static final RegistryObject<Item> ROSEGOLD_GREATSWORD = REGISTRY.register("rosegold_greatsword",
            () -> TieredWeapons.sword(1661, 8, 7f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -3.2f));
    public static final RegistryObject<Item> ROSEGOLD_HAMMER = REGISTRY.register("rosegold_hammer",
            () -> TieredWeapons.pickaxe(1761, 8, 7f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -3.4f));
    public static final RegistryObject<Item> ROSEGOLD_HOOK_SWORD = REGISTRY.register("rosegold_hook_sword",
            () -> TieredWeapons.sword(1561, 8, 4.5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.6f));
    public static final RegistryObject<Item> ROSEGOLD_KATANA = REGISTRY.register("rosegold_katana",
            () -> TieredWeapons.sword(1461, 8, 3.5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.2f));
    public static final RegistryObject<Item> ROSEGOLD_LONGSWORD = REGISTRY.register("rosegold_longsword",
            () -> TieredWeapons.sword(1661, 8, 5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.9f));
    public static final RegistryObject<Item> ROSEGOLD_SAW_CLEAVER = REGISTRY.register("rosegold_saw_cleaver",
            () -> TieredWeapons.sword(1561, 6, 5.5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.6f));
    public static final RegistryObject<Item> ROSEGOLD_SAW_CLEAVER_UNFOLDED = REGISTRY.register(
            "rosegold_saw_cleaver_unfolded",
            () -> TieredWeapons.sword(1561, 8, 4.5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.8f));
    public static final RegistryObject<Item> ROSEGOLD_SCYTHE = REGISTRY.register("rosegold_scythe",
            () -> TieredWeapons.sword(1561, 8, 6f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -3.1f));
    public static final RegistryObject<Item> ROSEGOLD_TWINBLADE = REGISTRY.register("rosegold_twinblade",
            () -> TieredWeapons.sword(1561, 8, 2f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -2.2f));
    public static final RegistryObject<Item> ROSEGOLD_ZWEIHANDER = REGISTRY.register("rosegold_zweihander",
            () -> TieredWeapons.sword(1681, 8, 5f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_ROSEGOLD_INGOT.get())), 3, -3.1f));
    public static final RegistryObject<Item> ROSEGOLD_BUSTER_SWORD = REGISTRY.register("rosegold_buster_sword",
            () -> TieredWeapons.sword(1761, 8, 9f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.HEAVY_ROSEGOLD_INGOT.get())), 3, -3.4f));
    public static final RegistryObject<Item> ROSEGOLD_GREATHAMMER = REGISTRY.register("rosegold_greathammer",
            () -> TieredWeapons.pickaxe(1861, 8, 11f, 3, 14,
                    Ingredient.of(new ItemStack(ModItems.HEAVY_ROSEGOLD_INGOT.get())), 3, -3.6f));
    public static final RegistryObject<Item> ROSEGOLD_PISTOL = REGISTRY.register("rosegold_pistol",
