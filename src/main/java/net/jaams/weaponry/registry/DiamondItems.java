...
public class DiamondItems {
    ...
    public static final RegistryObject<Item> HEAVY_DIAMOND = REGISTRY.register("heavy_diamond",
            () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DOUBLE_DIAMOND = REGISTRY.register("double_diamond",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> DIAMOND_DAGGER_REVERSE = REGISTRY.register("diamond_dagger_reverse",
    ...
    public static final RegistryObject<Item> DIAMOND_CLAW = REGISTRY.register("diamond_claw",
    ...
    public static final RegistryObject<Item> DIAMOND_BROADSWORD = REGISTRY.register("diamond_broadsword",
            () -> TieredWeapons.sword(1681, 8f, 5f, 3, 10, Ingredient.of(new ItemStack(ModItems.DOUBLE_DIAMOND.get())),
                    3, -2.8f));
    public static final RegistryObject<Item> DIAMOND_BUTTERFLY_SWORD = REGISTRY.register("diamond_butterfly_sword",
    ...
    public static final RegistryObject<Item> DIAMOND_LONGSWORD = REGISTRY.register("diamond_longsword",
            () -> TieredWeapons.sword(1661, 8f, 5f, 3, 10, Ingredient.of(new ItemStack(ModItems.DOUBLE_DIAMOND.get())),
                    3, -2.9f));
    public static final RegistryObject<Item> DIAMOND_SAW_CLEAVER = REGISTRY.register("diamond_saw_cleaver",
            () -> TieredWeapons.sword(1561, 6f, 5.5f, 3, 10,
                    Ingredient.of(new ItemStack(ModItems.DOUBLE_DIAMOND.get())), 3, -2.6f));
    public static final RegistryObject<Item> DIAMOND_SAW_CLEAVER_UNFOLDED = REGISTRY.register(
    ...
    public static final RegistryObject<Item> DIAMOND_SCYTHE = REGISTRY.register("diamond_scythe",
            () -> TieredWeapons.sword(1561, 8f, 6f, 3, 10, Ingredient.of(new ItemStack(ModItems.DOUBLE_DIAMOND.get())),
                    3, -3.1f));
    public static final RegistryObject<Item> DIAMOND_TWINBLADE = REGISTRY.register("diamond_twinblade",
    ...
    public static final RegistryObject<Item> DIAMOND_SHOTGUN = REGISTRY.register("diamond_shotgun",
