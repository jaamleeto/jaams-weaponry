...
public class GoldenItems {
	...
	public static final RegistryObject<Item> HEAVY_GOLD_INGOT = REGISTRY.register("heavy_gold_ingot", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> DOUBLE_GOLD_INGOT = REGISTRY.register("double_gold_ingot", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> GOLDEN_DAGGER_REVERSE = REGISTRY.register("golden_dagger_reverse",
	...
	public static final RegistryObject<Item> GOLDEN_CLEAVER = REGISTRY.register("golden_cleaver",
	...
	public static final RegistryObject<Item> GOLDEN_CLAW = REGISTRY.register("golden_claw",
	...
	public static final RegistryObject<Item> GOLDEN_BUTTERFLY_SWORD = REGISTRY.register("golden_butterfly_sword",
	...
	public static final RegistryObject<Item> GOLDEN_HOOK_SWORD = REGISTRY.register("golden_hook_sword",
	...
	public static final RegistryObject<Item> GOLDEN_SAW_CLEAVER = REGISTRY.register("golden_saw_cleaver",
			() -> TieredWeapons.sword(32, 12, 2.5f, 0, 22, Ingredient.of(new ItemStack(ModItems.DOUBLE_GOLD_INGOT.get())), 3, -2.6f));
	public static final RegistryObject<Item> GOLDEN_SAW_CLEAVER_UNFOLDED = REGISTRY.register("golden_saw_cleaver_unfolded",
	...
	public static final RegistryObject<Item> GOLDEN_TWINBLADE = REGISTRY.register("golden_twinblade",
	...
	public static final RegistryObject<Item> GOLDEN_PISTOL = REGISTRY.register("golden_pistol",
